...
public class SigitTDatoDistribDto extends SigitTDatoDistribPk {
	...
	protected Integer codiceImpianto;
	...
	public String toString() {
		return "SigitTDatoDistribDto [fkTipoContratto=" + fkTipoContratto + ", fkImportDistrib=" + fkImportDistrib
				+ ", fkCategoriaUtil=" + fkCategoriaUtil + ", fkCombustibile=" + fkCombustibile
				+ ", codiceAssenzaCatast=" + codiceAssenzaCatast + ", fkUnitaMisura=" + fkUnitaMisura + ", flgPfPg="
				+ flgPfPg + ", cognomeDenom=" + cognomeDenom + ", nome=" + nome + ", cfPiva=" + cfPiva + ", annoRif="
				+ annoRif + ", nrMesiFattur=" + nrMesiFattur + ", dug=" + dug + ", indirizzo=" + indirizzo + ", civico="
				+ civico + ", cap=" + cap + ", istatComune=" + istatComune + ", podPdr=" + podPdr + ", consumoAnno="
				+ consumoAnno + ", consumoMensile=" + consumoMensile + ", meseRiferimento=" + meseRiferimento
				+ ", consumoGiornaliero=" + consumoGiornaliero + ", giornoRiferimento=" + giornoRiferimento
				+ ", volumetria=" + volumetria + ", flgPfPgFatt=" + flgPfPgFatt + ", cognomeDenomFatt="
				+ cognomeDenomFatt + ", nomeFatt=" + nomeFatt + ", cfPivaFatt=" + cfPivaFatt + ", dugFatt=" + dugFatt
				+ ", indirizzoFatt=" + indirizzoFatt + ", civicoFatt=" + civicoFatt + ", capFatt=" + capFatt
