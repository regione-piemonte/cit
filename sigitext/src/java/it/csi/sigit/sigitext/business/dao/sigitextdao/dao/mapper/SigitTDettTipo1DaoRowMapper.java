...
import it.csi.sigit.sigitext.business.dao.sigitextdao.dao.impl.SigitTDettTipo1DaoImpl;
...
public class SigitTDettTipo1DaoRowMapper extends BaseDaoRowMapper implements org.springframework.jdbc.core.RowMapper {
	...
	public SigitTDettTipo1Dto mapRow_internal(SigitTDettTipo1Dto objectToFill, ResultSet rs, int row)
		...
		if (mapAllColumns || columnsToReadMap.get("E_1B_FLG_CUCINA") != null)
			dto.setE1bFlgCucina(rs.getBigDecimal("E_1B_FLG_CUCINA"));

		// colonna [E_1B_FLG_UNI_10389_2]
		if (mapAllColumns || columnsToReadMap.get("E_1B_FLG_UNI_10389_2") != null)
			dto.setE1bFlgUni103892(rs.getBigDecimal("E_1B_FLG_UNI_10389_2"));

		// colonna [E_1B_PARTICOLATO_MG_AL_M3]
		if (mapAllColumns || columnsToReadMap.get("E_1B_PARTICOLATO_MG_AL_M3") != null)
			dto.setE1bParticolatoMgAlM3(rs.getBigDecimal("E_1B_PARTICOLATO_MG_AL_M3"));
