 ...
 * @generated
 */
public class PersonaGiuridicaDaoRowMapper extends BaseDaoRowMapper
		implements
	 ...
	 */
	public PersonaGiuridicaDaoRowMapper(String[] columnsToRead, Class dtoClass, SigitTPersonaGiuridicaDao dao) {
	...
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		...
		if (dtoInstance instanceof PersonaGiuridica) {
			return mapRow_internal((PersonaGiuridica) dtoInstance, rs, row);
		}

		return dtoInstance;
	}

	public PersonaGiuridica mapRow_internal(PersonaGiuridica objectToFill, ResultSet rs, int row)
			throws SQLException {
		PersonaGiuridica dto = objectToFill;
		...
		if (mapAllColumns || columnsToReadMap.get("DES_STATO_PG") != null)
			dto.setDelegaSoggIncaricato(rs.getString("DES_STATO_PG"));
