...
import it.csi.sigit.sigitext.business.dao.sigitextdao.dao.impl.SigitTRappDettaglioDaoImpl;
import it.csi.sigit.sigitext.business.dao.sigitextdao.dto.SigitTRappDettaglioDto;
 ...
 * @generated
 */
public class SigitTRappDettaglioDaoRowMapper extends BaseDaoRowMapper implements org.springframework.jdbc.core.RowMapper {
	...
	public SigitTRappDettaglioDto mapRow_internal(SigitTRappDettaglioDto objectToFill, ResultSet rs, int row) throws SQLException {
