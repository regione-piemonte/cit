...
import it.csi.sigit.sigitext.business.dao.sigitextdao.dao.mapper.SigitTRappIspezGfDaoRowMapper;
...
public class SigitTRappIspezGfDaoImpl extends AbstractDAO implements SigitTRappIspezGfDao{
...

	{
		...
		params.addValue("ID_ALLEGATO", dto.getSigitTRappIspezGfPk().getIdAllegato(), java.sql.Types.NUMERIC);
		...
		return dto.getSigitTRappIspezGfPk();
	...
	public void delete(BigDecimal idAllegato) throws SigitTRappIspezGfDaoException {
		...
		LOG.debug("[SigitTRappIspezGfDaoImpl::delete] START");
		...
		LOG.debug("[SigitTRappIspezGfDaoImpl::delete] END");
