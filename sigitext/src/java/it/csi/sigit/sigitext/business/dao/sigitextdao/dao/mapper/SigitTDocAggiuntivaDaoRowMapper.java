...
import it.csi.sigit.sigitext.business.dao.sigitextdao.dao.SigitTDocAggiuntivaDao;
import it.csi.sigit.sigitext.business.dao.sigitextdao.dao.impl.SigitTDocAggiuntivaDaoImpl;
...
public class SigitTDocAggiuntivaDaoRowMapper extends BaseDaoRowMapper implements org.springframework.jdbc.core.RowMapper {
	...
	public SigitTDocAggiuntivaDto mapRow_internal(SigitTDocAggiuntivaDto objectToFill, ResultSet rs, int row) throws SQLException {
	...
	public SigitTDocAggiuntivaByCodImpDecodDto mapRow_internal(SigitTDocAggiuntivaByCodImpDecodDto objectToFill, ResultSet rs, int row) throws SQLException {
