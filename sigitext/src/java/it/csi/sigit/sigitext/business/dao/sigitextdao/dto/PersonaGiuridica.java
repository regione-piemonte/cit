 ...
 * @generated
 */
public class PersonaGiuridica extends SigitTPersonaGiuridicaPk {
	...
	private String descStatoPg;

	public String getDescStatoPg() {
		return descStatoPg;
	}

	public void setDescStatoPg(String descStatoPg) {
		this.descStatoPg = descStatoPg;
	}
