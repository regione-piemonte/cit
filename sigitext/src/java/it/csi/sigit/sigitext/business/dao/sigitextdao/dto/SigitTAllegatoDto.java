...
public class SigitTAllegatoDto extends SigitTAllegatoPk {
	...
	public String toString() {
		return "SigitTAllegatoDto{" + "fkStatoRapp=" + fkStatoRapp + ", fkTipoDocumento=" + fkTipoDocumento + ", fkSiglaBollino='" + fkSiglaBollino + '\'' + ", fkNumeroBollino=" + fkNumeroBollino
				+ ", dataControllo=" + dataControllo + ", bFlgLibrettoUso=" + bFlgLibrettoUso + ", bFlgDichiarConform=" + bFlgDichiarConform + ", bFlgLibImp=" + bFlgLibImp + ", bFlgLibCompl="
				+ bFlgLibCompl + ", fOsservazioni='" + fOsservazioni + '\'' + ", fRaccomandazioni='" + fRaccomandazioni + '\'' + ", fPrescrizioni='" + fPrescrizioni + '\'' + ", fFlgPuoFunzionare="
				+ fFlgPuoFunzionare + ", fInterventoEntro=" + fInterventoEntro + ", fOraArrivo='" + fOraArrivo + '\'' + ", fOraPartenza='" + fOraPartenza + '\'' + ", fDenominazTecnico='"
				+ fDenominazTecnico + '\'' + ", fFlgFirmaTecnico=" + fFlgFirmaTecnico + ", fFlgFirmaResponsabile=" + fFlgFirmaResponsabile + ", dataInvio=" + dataInvio + ", nomeAllegato='"
				+ nomeAllegato + '\'' + ", dataUltMod=" + dataUltMod + ", utenteUltMod='" + utenteUltMod + '\'' + ", cfRedattore='" + cfRedattore + '\'' + ", uidIndex='" + uidIndex + '\''
				+ ", fFirmaTecnico='" + fFirmaTecnico + '\'' + ", fFirmaResponsabile='" + fFirmaResponsabile + '\'' + ", flgControlloBozza=" + flgControlloBozza + ", aPotenzaTermicaNominaleMax="
				+ aPotenzaTermicaNominaleMax + ", elencoCombustibili='" + elencoCombustibili + '\'' + ", elencoApparecchiature='" + elencoApparecchiature + '\'' + ", dataRespinta=" + dataRespinta
				+ ", motivoRespinta='" + motivoRespinta + '\'' + ", fkPgCat=" + fkPgCat + ", abcdfControlloweb=" + abcdfControlloweb + ", fkTipoManutenzione=" + fkTipoManutenzione + ", altroDescr='"
				+ altroDescr + '\'' + ", fkIspezIspet=" + fkIspezIspet + ", dtInvioMemo=" + dtInvioMemo + ", mailInvioMemo='" + mailInvioMemo + '\'' + ", uidIndexFirmato='" + uidIndexFirmato + '\''
				+ ", nomeAllegatoFirmato='" + nomeAllegatoFirmato + '\'' + ", idAllegato=" + idAllegato + "} " + super.toString();
	}
}
