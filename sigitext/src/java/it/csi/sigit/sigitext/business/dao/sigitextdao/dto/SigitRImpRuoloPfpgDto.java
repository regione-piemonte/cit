...
public class SigitRImpRuoloPfpgDto extends SigitRImpRuoloPfpgPk {
	...
	public String toString() {
		return "SigitRImpRuoloPfpgDto{" + "fkRuolo=" + fkRuolo + ", codiceImpianto=" + codiceImpianto + ", dataInizio=" + dataInizio + ", dataFine=" + dataFine + ", fkPersonaFisica=" + fkPersonaFisica
				+ ", fkPersonaGiuridica=" + fkPersonaGiuridica + ", dataUltMod=" + dataUltMod + ", utenteUltMod='" + utenteUltMod + '\'' + ", flgPrimoCaricatore=" + flgPrimoCaricatore + "} " + super
				.toString();
	}
}
