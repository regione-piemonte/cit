...
import it.csi.sigit.sigitext.business.dao.sigitextdao.dao.impl.MvOdVistaDettaglioImpiantiDaoImpl;
...
public class MvOdVistaDettaglioImpiantiDaoRowMapper extends BaseDaoRowMapper
	...
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		...
		if (dtoInstance instanceof MvOdVistaDettaglioImpiantiDto) {
			return mapRow_internal((MvOdVistaDettaglioImpiantiDto) dtoInstance, rs);
		}

		return dtoInstance;
	}

	public MvOdVistaDettaglioImpiantiDto mapRow_internal(MvOdVistaDettaglioImpiantiDto objectToFill, ResultSet rs) throws SQLException {
