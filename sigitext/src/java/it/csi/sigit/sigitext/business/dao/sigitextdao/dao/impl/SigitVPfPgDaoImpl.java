...
import it.csi.sigit.sigitext.business.dao.sigitextdao.dao.SigitVPfPgDao;
import it.csi.sigit.sigitext.business.dao.sigitextdao.dao.filter.CodiceReaAndFiscaleAndDenomFilter;
import it.csi.sigit.sigitext.business.dao.sigitextdao.dao.mapper.SigitVPfPgDaoRowMapper;
...
public class SigitVPfPgDaoImpl extends AbstractDAO implements SigitVPfPgDao {
	...
	protected SigitVPfPgDaoRowMapper byCodiceFiscaleRowMapper = new SigitVPfPgDaoRowMapper(null, SigitVPfPgDto.class, this);
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<SigitVPfPgDto> findByCodiceFiscale(CodiceReaAndFiscaleAndDenomFilter input)
	...
	public List<SigitVPfPgDto> findByDenominazione(
			CodiceReaAndFiscaleAndDenomFilter input)
			throws SigitVPfPgDaoException {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<SigitVPfPgDto> findByFilter(CodiceReaAndFiscaleAndDenomFilter input)
			throws SigitVPfPgDaoException {
