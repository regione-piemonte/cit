 ...
 * @generated
 */
public class SigitTCompGfCompletoDaoRowMapper extends BaseDaoRowMapper implements org.springframework.jdbc.core.RowMapper {
	 ...
	 */
	public SigitTCompGfCompletoDaoRowMapper(String[] columnsToRead, Class dtoClass, SigitTCompGfDao dao) {
	...
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		...
		if (dtoInstance instanceof SigitTCompGfCompletoDto) {
			return mapRow_internal((SigitTCompGfCompletoDto) dtoInstance, rs, row);
		}

		return dtoInstance;
	}

	public SigitTCompGfCompletoDto mapRow_internal(SigitTCompGfCompletoDto objectToFill, ResultSet rs, int row) throws SQLException {
		SigitTCompGfCompletoDto dto = objectToFill;
		...
		if (mapAllColumns || columnsToReadMap.get("DESC_FONTE_EN_SFRUTTATA") != null)
			dto.setDesFonteEnSfruttata(rs.getString("DESC_FONTE_EN_SFRUTTATA"));
