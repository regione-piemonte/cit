...
# Project Description
Questa componente è una Componente Angular di frontend che si interfaccia alle API REST di COMBUSTYPWAWEB, realizzata in tecnica PWA, nativamente adattabile ai dispositivi sia mobili che desktop.

# Configurations
Aprire il file src/environments/environment.dev-rp-01.ts e configurare i seguenti parametri:
- apiUrl: url dei servizi COMBUSTYPWAWEB;
- shibbolethSSOLogoutURL: url di logout;
- urlNotifiche: url della gestione delle notifiche;
...
# Installing
Il pacchetto generato devrà essere inserito all'interno del pacchetto generato da COMBUSTYPWAWEB sotto combustypwaweb.ear\combustypwaweb-web.war\.  
