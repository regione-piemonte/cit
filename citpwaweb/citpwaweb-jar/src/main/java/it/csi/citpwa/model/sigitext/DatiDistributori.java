...
public class DatiDistributori implements Serializable {

    private static final long serialVersionUID = 1L;
    private BigDecimal idDatoDistri;
    private BigDecimal fkStatoDistrib;
    private String statoDistribDesc;
    ...
    public String getStatoDistribDesc() {
        return statoDistribDesc;
    }

    public void setStatoDistribDesc(String statoDistribDesc) {
        this.statoDistribDesc = statoDistribDesc;
    }

    @Override
    public String toString() {
        return "DatiDistributori{" +
                "idDatoDistri=" + idDatoDistri +
                ", fkStatoDistrib=" + fkStatoDistrib +
                ", fkTipoContratto=" + fkTipoContratto +
                ", desTipoContrattoDistrib='" + desTipoContrattoDistrib + '\'' +
                ", idImportDistrib=" + idImportDistrib +
                ", fkCategoriaUtil='" + fkCategoriaUtil + '\'' +
                ", desCategoriaUtil='" + desCategoriaUtil + '\'' +
                ", fkCombustibile=" + fkCombustibile +
                ", desCombustibile='" + desCombustibile + '\'' +
                ", codiceAssenzaCatast='" + codiceAssenzaCatast + '\'' +
                ", desAssenzaCatast='" + desAssenzaCatast + '\'' +
                ", fkUnitaMisura=" + fkUnitaMisura +
                ", desUnitaMisura='" + desUnitaMisura + '\'' +
                ", flgPfPg='" + flgPfPg + '\'' +
                ", cognomeDenom='" + cognomeDenom + '\'' +
                ", nome='" + nome + '\'' +
                ", cfPiva='" + cfPiva + '\'' +
                ", annoRif='" + annoRif + '\'' +
                ", nrMesiFattur=" + nrMesiFattur +
                ", dug='" + dug + '\'' +
                ", indirizzo='" + indirizzo + '\'' +
                ", civico='" + civico + '\'' +
                ", cap='" + cap + '\'' +
                ...
                ", giornoRiferimento=" + giornoRiferimento +
                ", volumetria='" + volumetria + '\'' +
                ", flgPfPgFatt='" + flgPfPgFatt + '\'' +
                ", cognomeDenomFatt='" + cognomeDenomFatt + '\'' +
                ", nomeFatt='" + nomeFatt + '\'' +
                ", cfPivaFatt='" + cfPivaFatt + '\'' +
                ", dugFatt='" + dugFatt + '\'' +
                ", indirizzoFatt='" + indirizzoFatt + '\'' +
                ", civicoFatt='" + civicoFatt + '\'' +
                ", capFatt='" + capFatt + '\'' +
                ", istatComuneFatt='" + istatComuneFatt + '\'' +
                '}';
    }
}
