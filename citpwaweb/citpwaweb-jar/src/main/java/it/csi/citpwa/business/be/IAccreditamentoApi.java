...
public interface IAccreditamentoApi {
	...
	@Produces({"application/json"})
	Response getElencoIncarichi(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest, @QueryParam("id_persona_giuridica") Integer idPersonaGiuridica);

	@GET
	@Path("/getElencoDeleghe")
	@Produces({"application/json"})
	Response getElencoDeleghe(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest, @QueryParam("id_persona_giuridica") Integer idPersonaGiuridica);
