package it.csi.citpwa.model.sigitext.RapProva;
...
public class DatiGT {
	...
	private Long dataDismiss;
	private Integer flgDismissione;
	private Long dataUltMod;
	...
	private Long dataMinimaControllo;
	private Long dataMassimaControllo;
	...
	public Long getDataDismiss() {
		return dataDismiss;
	}

	public void setDataDismiss(Long dataDismiss) {
	...
	public Long getDataUltMod() {
		return dataUltMod;
	}

	public void setDataUltMod(Long dataUltMod) {
	...
	public Long getDataMinimaControllo() {
		return dataMinimaControllo;
	}

	public void setDataMinimaControllo(Long dataMinimaControllo) {
		this.dataMinimaControllo = dataMinimaControllo;
	}

	public Long getDataMassimaControllo() {
		return dataMassimaControllo;
	}

	public void setDataMassimaControllo(Long dataMassimaControllo) {
	...
	public String toString() {
		return "DatiGT{" + "idTipoComponente='" + idTipoComponente + '\'' + ", progressivo=" + progressivo + ", dataInstall=" + dataInstall + ", codiceImpianto=" + codiceImpianto + ", fkFluido="
				...
				+ descMarca + '\'' + ", descFluido='" + descFluido + '\'' + ", descDettaglioGt='" + descDettaglioGt + '\'' + ", descCombustibile='" + desCombustibile + '\'' + '}';
	}
}