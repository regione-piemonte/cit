...
public class ResponseGetElencoDocumenti implements Serializable {
	...
	public void setDocumentiAllegatiImpianto(List<DocumentiAllegatiImpianto> documentiAllegatiImpianto) {
		this.documentiAllegatiImpianto = documentiAllegatiImpianto;
	}
}
