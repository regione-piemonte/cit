...
----------------------------------------------------------------------------------------
-- 18/11/2021  Lorita
-- Aggiunta campo e_nox_mg/Nm3
--  come da mail di Mariuccia del 18/11/2021 10:42
-- solo DEV
----------------------------------------------------------------------------------------
ALTER TABLE sigit_new.sigit_t_dett_tipo1 ADD COLUMN e_nox_mg_nm3 NUMERIC;

----------------------------------------------------------------------------------------
-- 19/11/2021  Lorita
-- Modifica viste per aggiunta campo e_nox_mg/Nm3
--  come da mail di Mariuccia del 18/11/2021 10:42
-- solo DEV
-- 23/11/2021  Lorita
-- Modifica viste *od_vista_dettaglio_impianti per aggiunta campi coord_x_long_dd, coord_y_lat_dd 
--  come da mail di Mariuccia del 19/11/2021 15:00
-- solo DEV
----------------------------------------------------------------------------------------
...
AS SELECT sigit_t_dett_tipo1.codice_impianto,
  ...
  WHERE sigit_t_allegato.fk_tipo_documento = ANY (ARRAY[3::numeric, 14::numeric])
UNION
...
GRANT ALL ON TABLE sigit_new.vista_comp_gt_dett TO sigit_new;
GRANT INSERT, SELECT, UPDATE, DELETE ON TABLE sigit_new.vista_comp_gt_dett TO sigit_new_rw;
GRANT SELECT ON TABLE sigit_new.vista_comp_gt_dett TO sigit_new_ro;
...
AS SELECT i.codice_impianto,
    ...
    ui.pdr_gas,
    gt.e_nox_mg_nm3,
    i.coord_x_long_dd, i.coord_y_lat_dd
...
GRANT SELECT ON TABLE sigit_new.od_vista_dettaglio_impianti TO sigit_new_ro;
