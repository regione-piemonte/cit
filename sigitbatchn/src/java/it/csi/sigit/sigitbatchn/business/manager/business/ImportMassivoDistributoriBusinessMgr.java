 ...
 */
public class ImportMassivoDistributoriBusinessMgr { //extends AllegatiBusinessManager {
	/**
	 * Nome della classe
	 */
	final static String CLASS_NAME = ImportMassivoDistributoriBusinessMgr.class.getSimpleName();
