...
@Component({
    selector: 'app-aggiungi-documento-contratto',
    templateUrl: './aggiungi-documento-contratto.component.html',
    styleUrls: ['./aggiungi-documento-contratto.component.scss'],
    animations: [
...
export class AggiungiDocumentoContrattoComponent implements OnInit {

    TIPO_DOCUMENTO_CONTRATTO_DELEGA_A_TERZO_RESPONSABILE = "8";
    ...
    ngOnInit(): void {
        ...
        this.backService.setBackTitle("Torna a Elenco documenti associati al contratto");
        ...
        this.route.queryParamMap.subscribe((params) => {
            this.idContratto = params.get('idContratto');
        });
    ...
    async uploadDocument(idContratto) {
        ...
        let documento: Documento = {
            ...
            isPdfStatico: false,
            encoding: null,
            tipoDocumento: this.TIPO_DOCUMENTO_CONTRATTO_DELEGA_A_TERZO_RESPONSABILE,
            descrizione: this.nuovoDocumentoForm.get('descrizioneDocumentoControl').value
        }
        this.documentiImpiantoService.uploadDocumentoContratto(idContratto, this.codiceImpianto, "3 resp", idAzione, documento).subscribe((res) => {
