 ...
 * @generated
 */
public class OdVistaDettaglioImpiantiMetadata extends DAOMetadata {
	 ...
	 * DAO: [odVistaDettaglioImpianti]
	 * tabella: [OD_VISTA_DETTAGLIO_IMPIANTI].
	 */
	public OdVistaDettaglioImpiantiMetadata() {
	...
	/**
	 * Method 'getTableName'
	 * Restituisce il nome della tabella a cui il DAO [odVistaDettaglioImpianti] fa riferimento
	 * (OD_VISTA_DETTAGLIO_IMPIANTI).
	 * @return String
	 * @generated
	 */
