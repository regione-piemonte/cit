...
/**
 * RowMapper specifico del DAO OdVistaDettaglioImpiantiDao
 * @generated
 */
public class OdVistaDettaglioImpiantiDaoRowMapper extends BaseDaoRowMapper
		implements
	 ...
	 * @generated
	 */
	OdVistaDettaglioImpiantiDaoImpl dao;
	 ...
	 */
	public OdVistaDettaglioImpiantiDaoRowMapper(String[] columnsToRead, Class dtoClass,
			OdVistaDettaglioImpiantiDao dao) {
		super(columnsToRead, dtoClass);
		this.dao = (OdVistaDettaglioImpiantiDaoImpl) dao;
	}
	 ...
	 * @param row
	 * @throws SQLException
	 * @return OdVistaDettaglioImpiantiDto
	 * @generated
	 */
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		Object dtoInstance = getNewDto();

		if (dtoInstance instanceof OdVistaDettaglioImpiantiDto) {
			return mapRow_internal((OdVistaDettaglioImpiantiDto) dtoInstance, rs, row);
		}

		return dtoInstance;
	}

	public OdVistaDettaglioImpiantiDto mapRow_internal(OdVistaDettaglioImpiantiDto objectToFill, ResultSet rs, int row)
			throws SQLException {
		OdVistaDettaglioImpiantiDto dto = objectToFill;
