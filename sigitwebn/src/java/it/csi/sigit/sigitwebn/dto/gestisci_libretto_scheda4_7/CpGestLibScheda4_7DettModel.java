package it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_7;
 ...
 * logica di business associata alla Schermata [cpGestLibScheda4_7Dett]
 */
@Validation
public class CpGestLibScheda4_7DettModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatacomponenteCS'
	 * @param value
	 * @generated
	 */

	public void setAppDatacomponenteCS(it.csi.sigit.sigitwebn.dto.libretto.ComponenteCS value) {
		getSession().put("appDatacomponenteCS", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatacomponenteCS'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.libretto.ComponenteCS getAppDatacomponenteCS() {
		return (it.csi.sigit.sigitwebn.dto.libretto.ComponenteCS) (getSession().get("appDatacomponenteCS"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDatalistaComponentiCS'
	 * @param value
	 * @generated
	 */

	public void setAppDatalistaComponentiCS(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteCS> value) {
		getSession().put("appDatalistaComponentiCS", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatalistaComponentiCS'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteCS> getAppDatalistaComponentiCS() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteCS>) (getSession()
				.get("appDatalistaComponentiCS"));
	}
