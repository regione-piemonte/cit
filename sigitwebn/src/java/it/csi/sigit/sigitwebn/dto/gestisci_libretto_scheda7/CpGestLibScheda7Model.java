package it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda7;
 ...
 * logica di business associata alla Schermata [cpGestLibScheda7]
 */
@Validation
public class CpGestLibScheda7Model extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatasistemaEmissione'
	 * @param value
	 * @generated
	 */

	public void setAppDatasistemaEmissione(it.csi.sigit.sigitwebn.dto.libretto.SistemaEmissione value) {
		getSession().put("appDatasistemaEmissione", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatasistemaEmissione'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.libretto.SistemaEmissione getAppDatasistemaEmissione() {
		return (it.csi.sigit.sigitwebn.dto.libretto.SistemaEmissione) (getSession().get("appDatasistemaEmissione"));
	}
