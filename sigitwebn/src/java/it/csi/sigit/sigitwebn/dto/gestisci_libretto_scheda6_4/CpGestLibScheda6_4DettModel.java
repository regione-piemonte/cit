package it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda6_4;
 ...
 * logica di business associata alla Schermata [cpGestLibScheda6_4Dett]
 */
@Validation
public class CpGestLibScheda6_4DettModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatacomponentePO'
	 * @param value
	 * @generated
	 */

	public void setAppDatacomponentePO(it.csi.sigit.sigitwebn.dto.libretto.ComponentePO value) {
		getSession().put("appDatacomponentePO", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatacomponentePO'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.libretto.ComponentePO getAppDatacomponentePO() {
		return (it.csi.sigit.sigitwebn.dto.libretto.ComponentePO) (getSession().get("appDatacomponentePO"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDatalistaComponentiPO'
	 * @param value
	 * @generated
	 */

	public void setAppDatalistaComponentiPO(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponentePO> value) {
		getSession().put("appDatalistaComponentiPO", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatalistaComponentiPO'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponentePO> getAppDatalistaComponentiPO() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponentePO>) (getSession()
				.get("appDatalistaComponentiPO"));
	}
