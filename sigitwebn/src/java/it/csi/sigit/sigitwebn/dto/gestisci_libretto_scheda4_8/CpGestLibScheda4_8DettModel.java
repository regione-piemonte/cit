package it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_8;
 ...
 * logica di business associata alla Schermata [cpGestLibScheda4_8Dett]
 */
@Validation
public class CpGestLibScheda4_8DettModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatacomponenteAG'
	 * @param value
	 * @generated
	 */

	public void setAppDatacomponenteAG(it.csi.sigit.sigitwebn.dto.libretto.ComponenteAG value) {
		getSession().put("appDatacomponenteAG", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatacomponenteAG'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.libretto.ComponenteAG getAppDatacomponenteAG() {
		return (it.csi.sigit.sigitwebn.dto.libretto.ComponenteAG) (getSession().get("appDatacomponenteAG"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDatalistaComponentiAG'
	 * @param value
	 * @generated
	 */

	public void setAppDatalistaComponentiAG(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteAG> value) {
		getSession().put("appDatalistaComponentiAG", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatalistaComponentiAG'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteAG> getAppDatalistaComponentiAG() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteAG>) (getSession()
				.get("appDatalistaComponentiAG"));
	}
