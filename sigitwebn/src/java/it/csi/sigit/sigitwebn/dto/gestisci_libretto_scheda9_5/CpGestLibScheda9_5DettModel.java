 ...
 * logica di business associata alla Schermata [cpGestLibScheda9_5Dett]
 */
@Validation
public class CpGestLibScheda9_5DettModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatacomponenteUT'
	 * @param value
	 * @generated
	 */

	public void setAppDatacomponenteUT(it.csi.sigit.sigitwebn.dto.libretto.ComponenteUT value) {
		getSession().put("appDatacomponenteUT", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatacomponenteUT'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.libretto.ComponenteUT getAppDatacomponenteUT() {
		return (it.csi.sigit.sigitwebn.dto.libretto.ComponenteUT) (getSession().get("appDatacomponenteUT"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDatalistaComponentiUT'
	 * @param value
	 * @generated
	 */

	public void setAppDatalistaComponentiUT(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteUT> value) {
		getSession().put("appDatalistaComponentiUT", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatalistaComponentiUT'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteUT> getAppDatalistaComponentiUT() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteUT>) (getSession()
				.get("appDatalistaComponentiUT"));
	}
