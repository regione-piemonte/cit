package it.csi.sigit.sigitwebn.dto.gestisci_impianto_resp;
 ...
 * logica di business associata alla Schermata [cpGestImpiantoResp]
 */
@Validation
public class CpGestImpiantoRespModel extends BaseSessionAwareDTO {
