package it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_2;
 ...
 * logica di business associata alla Schermata [cpGestLibScheda9_2Dett]
 */
@Validation
public class CpGestLibScheda9_2DettModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatacomponenteRV'
	 * @param value
	 * @generated
	 */

	public void setAppDatacomponenteRV(it.csi.sigit.sigitwebn.dto.libretto.ComponenteRV value) {
		getSession().put("appDatacomponenteRV", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatacomponenteRV'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.libretto.ComponenteRV getAppDatacomponenteRV() {
		return (it.csi.sigit.sigitwebn.dto.libretto.ComponenteRV) (getSession().get("appDatacomponenteRV"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDatalistaComponentiRV'
	 * @param value
	 * @generated
	 */

	public void setAppDatalistaComponentiRV(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteRV> value) {
		getSession().put("appDatalistaComponentiRV", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatalistaComponentiRV'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteRV> getAppDatalistaComponentiRV() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteRV>) (getSession()
				.get("appDatalistaComponentiRV"));
	}
