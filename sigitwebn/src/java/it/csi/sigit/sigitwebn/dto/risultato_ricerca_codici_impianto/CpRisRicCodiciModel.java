package it.csi.sigit.sigitwebn.dto.risultato_ricerca_codici_impianto;
 ...
 * logica di business associata alla Schermata [cpRisRicCodici]
 */
@Validation
public class CpRisRicCodiciModel extends BaseSessionAwareDTO {
	...
	public void setAppDataacquisizioneCodiciImpianto(
		...
		getSession().put("appDataacquisizioneCodiciImpianto", value);
	}
	...
	public it.csi.sigit.sigitwebn.dto.codici_impianto.AcquisizioneCodici getAppDataacquisizioneCodiciImpianto() {
		return (it.csi.sigit.sigitwebn.dto.codici_impianto.AcquisizioneCodici) (getSession()
				.get("appDataacquisizioneCodiciImpianto"));
	}
