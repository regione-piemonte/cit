package it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_4;
 ...
 * logica di business associata alla Schermata [cpGestLibScheda9_4Dett]
 */
@Validation
public class CpGestLibScheda9_4DettModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatacomponenteCI'
	 * @param value
	 * @generated
	 */

	public void setAppDatacomponenteCI(it.csi.sigit.sigitwebn.dto.libretto.ComponenteCI value) {
		getSession().put("appDatacomponenteCI", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatacomponenteCI'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.libretto.ComponenteCI getAppDatacomponenteCI() {
		return (it.csi.sigit.sigitwebn.dto.libretto.ComponenteCI) (getSession().get("appDatacomponenteCI"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDatalistaComponentiCI'
	 * @param value
	 * @generated
	 */

	public void setAppDatalistaComponentiCI(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteCI> value) {
		getSession().put("appDatalistaComponentiCI", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatalistaComponentiCI'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteCI> getAppDatalistaComponentiCI() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteCI>) (getSession()
				.get("appDatalistaComponentiCI"));
	}
