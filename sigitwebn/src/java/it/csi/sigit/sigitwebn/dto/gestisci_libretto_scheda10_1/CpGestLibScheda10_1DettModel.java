package it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda10_1;
 ...
 * logica di business associata alla Schermata [cpGestLibScheda10_1Dett]
 */
@Validation
public class CpGestLibScheda10_1DettModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatacomponenteVM'
	 * @param value
	 * @generated
	 */

	public void setAppDatacomponenteVM(it.csi.sigit.sigitwebn.dto.libretto.ComponenteVM value) {
		getSession().put("appDatacomponenteVM", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatacomponenteVM'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.libretto.ComponenteVM getAppDatacomponenteVM() {
		return (it.csi.sigit.sigitwebn.dto.libretto.ComponenteVM) (getSession().get("appDatacomponenteVM"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDatalistaComponentiVM'
	 * @param value
	 * @generated
	 */

	public void setAppDatalistaComponentiVM(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteVM> value) {
		getSession().put("appDatalistaComponentiVM", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatalistaComponentiVM'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteVM> getAppDatalistaComponentiVM() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteVM>) (getSession()
				.get("appDatalistaComponentiVM"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDataelencoTipoDettaglioVm'
	 * @param value
	 * @generated
	 */

	public void setAppDataelencoTipoDettaglioVm(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.common.CodeDescription> value) {
		getSession().put("appDataelencoTipoDettaglioVm", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDataelencoTipoDettaglioVm'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.common.CodeDescription> getAppDataelencoTipoDettaglioVm() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.common.CodeDescription>) (getSession()
				.get("appDataelencoTipoDettaglioVm"));
	}
