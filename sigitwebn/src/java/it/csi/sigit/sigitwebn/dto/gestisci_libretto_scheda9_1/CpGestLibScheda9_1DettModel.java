package it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_1;
 ...
 * logica di business associata alla Schermata [cpGestLibScheda9_1Dett]
 */
@Validation
public class CpGestLibScheda9_1DettModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatacomponenteTE'
	 * @param value
	 * @generated
	 */

	public void setAppDatacomponenteTE(it.csi.sigit.sigitwebn.dto.libretto.ComponenteTE value) {
		getSession().put("appDatacomponenteTE", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatacomponenteTE'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.libretto.ComponenteTE getAppDatacomponenteTE() {
		return (it.csi.sigit.sigitwebn.dto.libretto.ComponenteTE) (getSession().get("appDatacomponenteTE"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDatalistaComponentiTE'
	 * @param value
	 * @generated
	 */

	public void setAppDatalistaComponentiTE(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteTE> value) {
		getSession().put("appDatalistaComponentiTE", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatalistaComponentiTE'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteTE> getAppDatalistaComponentiTE() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteTE>) (getSession()
				.get("appDatalistaComponentiTE"));
	}
