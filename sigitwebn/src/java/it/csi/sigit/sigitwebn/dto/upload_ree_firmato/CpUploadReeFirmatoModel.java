package it.csi.sigit.sigitwebn.dto.upload_ree_firmato;
 ...
 * logica di business associata alla Schermata [cpUploadReeFirmato]
 */
@Validation
public class CpUploadReeFirmatoModel extends BaseSessionAwareDTO {
	...
	// FileUpload widg_fupReeFirmato
	private File widgFupReeFirmato; // The actual file(s)
	private String widgFupReeFirmatoContentType; // The content type of the file(s) 
	private String widgFupReeFirmatoFileName; // The uploaded file(s) name and path 

	public void setWidg_fupReeFirmato(File value) {
		widgFupReeFirmato = value;
	}
	@JSON(include = false)
	public File getWidg_fupReeFirmato() {
		return widgFupReeFirmato;
	}

	public void setWidg_fupReeFirmatoContentType(String value) {
		widgFupReeFirmatoContentType = value;
	}
	@JSON(include = false)
	public String getWidg_fupReeFirmatoContentType() {
		return widgFupReeFirmatoContentType;
	}

	public void setWidg_fupReeFirmatoFileName(String value) {
		widgFupReeFirmatoFileName = value;
	}
	@JSON(include = false)
	public String getWidg_fupReeFirmatoFileName() {
		return widgFupReeFirmatoFileName;
	}
