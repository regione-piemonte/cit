package it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_1vr;
 ...
 * logica di business associata alla Schermata [cpGestLibScheda5_1VRDett]
 */
@Validation
public class CpGestLibScheda5_1VRDettModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatacomponenteVR'
	 * @param value
	 * @generated
	 */

	public void setAppDatacomponenteVR(it.csi.sigit.sigitwebn.dto.libretto.ComponenteVR value) {
		getSession().put("appDatacomponenteVR", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatacomponenteVR'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.libretto.ComponenteVR getAppDatacomponenteVR() {
		return (it.csi.sigit.sigitwebn.dto.libretto.ComponenteVR) (getSession().get("appDatacomponenteVR"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDatalistaComponentiVR'
	 * @param value
	 * @generated
	 */

	public void setAppDatalistaComponentiVR(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteVR> value) {
		getSession().put("appDatalistaComponentiVR", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatalistaComponentiVR'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteVR> getAppDatalistaComponentiVR() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteVR>) (getSession()
				.get("appDatalistaComponentiVR"));
	}
