package it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda1_extra;
 ...
 * logica di business associata alla Schermata [cpGestLibScheda1_extra]
 */
@Validation
public class CpGestLibScheda1_extraModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatalistaPkTabellaEdit'
	 * @param value
	 * @generated
	 */

	public void setAppDatalistaPkTabellaEdit(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.PkTabellaEdit> value) {
		getSession().put("appDatalistaPkTabellaEdit", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatalistaPkTabellaEdit'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.PkTabellaEdit> getAppDatalistaPkTabellaEdit() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.PkTabellaEdit>) (getSession()
				.get("appDatalistaPkTabellaEdit"));
	}
