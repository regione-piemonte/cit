package it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_3;
 ...
 * logica di business associata alla Schermata [cpGestLibScheda9_3Dett]
 */
@Validation
public class CpGestLibScheda9_3DettModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatacomponenteSCX'
	 * @param value
	 * @generated
	 */

	public void setAppDatacomponenteSCX(it.csi.sigit.sigitwebn.dto.libretto.ComponenteSCX value) {
		getSession().put("appDatacomponenteSCX", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatacomponenteSCX'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.libretto.ComponenteSCX getAppDatacomponenteSCX() {
		return (it.csi.sigit.sigitwebn.dto.libretto.ComponenteSCX) (getSession().get("appDatacomponenteSCX"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDatalistaComponentiSCX'
	 * @param value
	 * @generated
	 */

	public void setAppDatalistaComponentiSCX(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteSCX> value) {
		getSession().put("appDatalistaComponentiSCX", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatalistaComponentiSCX'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteSCX> getAppDatalistaComponentiSCX() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteSCX>) (getSession()
				.get("appDatalistaComponentiSCX"));
	}
