package it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_1sr;
 ...
 * logica di business associata alla Schermata [cpGestLibScheda5_1SRDett]
 */
@Validation
public class CpGestLibScheda5_1SRDettModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatacomponenteSR'
	 * @param value
	 * @generated
	 */

	public void setAppDatacomponenteSR(it.csi.sigit.sigitwebn.dto.libretto.ComponenteSR value) {
		getSession().put("appDatacomponenteSR", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatacomponenteSR'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.libretto.ComponenteSR getAppDatacomponenteSR() {
		return (it.csi.sigit.sigitwebn.dto.libretto.ComponenteSR) (getSession().get("appDatacomponenteSR"));
	}

	/**
	 * imposta il valore dell' ApplicationData 'appDatalistaComponentiSR'
	 * @param value
	 * @generated
	 */

	public void setAppDatalistaComponentiSR(
			java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteSR> value) {
		getSession().put("appDatalistaComponentiSR", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatalistaComponentiSR'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteSR> getAppDatalistaComponentiSR() {
		return (java.util.ArrayList<it.csi.sigit.sigitwebn.dto.libretto.ComponenteSR>) (getSession()
				.get("appDatalistaComponentiSR"));
	}
