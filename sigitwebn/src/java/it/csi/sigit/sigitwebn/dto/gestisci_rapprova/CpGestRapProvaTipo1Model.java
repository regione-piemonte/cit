 ...
 * logica di business associata alla Schermata [cpGestRapProvaTipo1]
 */
@Validation
public class CpGestRapProvaTipo1Model extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDataTipoGT'
	 * @param value
	 * @generated
	 */

	public void setAppDataTipoGT(it.csi.sigit.sigitwebn.dto.rappprova.TipoGT value) {
		getSession().put("appDataTipoGT", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDataTipoGT'
	 * @generated
	 */
	public it.csi.sigit.sigitwebn.dto.rappprova.TipoGT getAppDataTipoGT() {
		return (it.csi.sigit.sigitwebn.dto.rappprova.TipoGT) (getSession().get("appDataTipoGT"));
	}
