...
import it.csi.sigit.sigitwebn.dto.gestisci_rapprova.CpGestRapProvaGeneraleModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_rapprova.states.CpGestRapProvaGeneraleScreenStates;
...
/**
 * CpGestRapProvaGeneraleAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestRapProvaGeneraleAction extends AbstractCPAction<CpGestRapProvaGeneraleModel>
		implements
			Preparable,
			ModelDriven<CpGestRapProvaGeneraleModel> {
	 ...
	 * strato di business.
	 */
	private CpGestRapProvaGeneraleModel model;
	 ...
	 * strato di business.
	 */
	public CpGestRapProvaGeneraleModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestRapProvaGeneraleModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestRapProvaGeneraleModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestRapProvaGenerale";
	...
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_rapprova.CpGestRapProvaGeneraleModel.class;
	}
	...
	public String handleMenuRapProva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_rapprova", "cpgestrapprovagenerale", "menuRapProva", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_rapprova", "cpgestrapprovagenerale", "btnIndietro", "CLICKED");
	...
	/**
	 * Prepara l'input stream referenziato dal result "provideData" con i valori relativi 
	 * al data-binding relativo al dataset DATASET del widget tbLocalizzazioni.
	 * @return sempre il result "provideData"
	 */
	@SkipValidation
	@FatClientOnly
	public String provideTbLocalizzazioni_DATASET() throws CommandExecutionException {
	...
	public void validate() {
		/*PROTECTED REGION ID(R251938495) ENABLED START*/
