package it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda4_1;
...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_1.CpGestLibScheda4_1DettModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda4_1.states.CpGestLibScheda4_1DettScreenStates;
...
/**
 * CpGestLibScheda4_1DettAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda4_1DettAction extends AbstractCPAction<CpGestLibScheda4_1DettModel>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda4_1DettModel> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda4_1DettModel model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda4_1DettModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda4_1DettModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda4_1DettModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda4_1Dett";

	/**
	 * nome del namespace che contiene il content panel
	 */
	private static final String CP_NAMESPACE = "gestisci_libretto_scheda4_1";

	/**
	 * nome completo del namespace che contiene il content panel
	 */
	private static final String CP_FULL_NAMESPACE = "/base/gestisci_libretto_scheda4_1";
	...
	private static final String URL_BACK_COMMAND = "/base/gestisci_libretto_scheda4_1/" + CP_NAME;

	/**
	 * classe model associata al ContentPanel
	 */
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_1.CpGestLibScheda4_1DettModel.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_1", "cpgestlibscheda4_1dett", "menuLibretto", "CLICKED");
	...
	public String handleBSostituisciComponente_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_1", "cpgestlibscheda4_1dett", "bSostituisciComponente",
				"CLICKED");
	...
	public String handleBDismettiComponente_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_1", "cpgestlibscheda4_1dett", "bDismettiComponente",
				"CLICKED");
	...
	public String handleBRiattivaComponente_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_1", "cpgestlibscheda4_1dett", "bRiattivaComponente",
				"CLICKED");
	...
	public String handleTbSostituzioni_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_1", "cpgestlibscheda4_1dett", "tbSostituzioni",
				"CLICKED");
	...
	public String handleBtRipristinaAttualeDett_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_1", "cpgestlibscheda4_1dett", "btRipristinaAttualeDett",
				"CLICKED");
	...
	public String handleBtSalvaDett_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_1", "cpgestlibscheda4_1dett", "btSalvaDett", "CLICKED");
	...
	public String handleBtIndietroDett_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_1", "cpgestlibscheda4_1dett", "btIndietroDett",
				"CLICKED");
	...
	/**
	 * Prepara l'input stream referenziato dal result "provideData" con i valori relativi 
	 * al data-binding relativo al dataset DATASET del widget cbFluido.
	 * @return sempre il result "provideData"
	 */
	@SkipValidation
	@FatClientOnly
	public String provideCbFluido_DATASET() throws CommandExecutionException {

		return provideDataInternal("appDataelencoFluidiTermovettore", "", false, false);
	}
	...
	public String provideCbTipologia_DATASET() throws CommandExecutionException {
		...
		return provideDataInternal("appDataelencoDettaglioGT", "", false, false);
	}

	/**
	 * Prepara l'input stream referenziato dal result "provideData" con i valori relativi 
	 * al data-binding relativo al dataset DATASET del widget cbTipologiaCannaFumaria.
	 * @return sempre il result "provideData"
	 */
	@SkipValidation
	@FatClientOnly
	public String provideCbTipologiaCannaFumaria_DATASET() throws CommandExecutionException {

		return provideDataInternal("appDataelencoCannaFumaria", "", false, false);
	}
	...
	public String provideTbSostituzioni_DATASET() throws CommandExecutionException {
		...
		return provideDataInternal("appDatalistaStoricoComponentiGT", "", false, false);
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R-985159205) ENABLED START*/
