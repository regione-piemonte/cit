...
import it.csi.sigit.sigitwebn.dto.gestisci_rapprova.CpGestRapProvaTipo1Model;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_rapprova.states.CpGestRapProvaTipo1ScreenStates;
...
/**
 * CpGestRapProvaTipo1Action Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestRapProvaTipo1Action extends AbstractCPAction<CpGestRapProvaTipo1Model>
		implements
			Preparable,
			ModelDriven<CpGestRapProvaTipo1Model> {
	 ...
	 * strato di business.
	 */
	private CpGestRapProvaTipo1Model model;
	 ...
	 * strato di business.
	 */
	public CpGestRapProvaTipo1Model getModel() {
		return model;
	}
	...
	public void setModel(CpGestRapProvaTipo1Model modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestRapProvaTipo1Model();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestRapProvaTipo1";
	...
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_rapprova.CpGestRapProvaTipo1Model.class;
	}
	...
	public String handleMenuRapProva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_rapprova", "cpgestrapprovatipo1", "menuRapProva", "CLICKED");
	...
	public String handleBSalvaRapProva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_rapprova", "cpgestrapprovatipo1", "bSalvaRapProva", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_rapprova", "cpgestrapprovatipo1", "btnIndietro", "CLICKED");
	...
	public String provideCbSiglaBollino_DATASET() throws CommandExecutionException {
		...
		return provideDataInternal("appDataElencoBolliniRappProva", "", false, false);
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R1540581605) ENABLED START*/
