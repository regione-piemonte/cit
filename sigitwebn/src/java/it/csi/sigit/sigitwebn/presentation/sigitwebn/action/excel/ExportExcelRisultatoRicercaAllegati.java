...
public class ExportExcelRisultatoRicercaAllegati extends BaseAction<BaseSessionAwareDTO> {
	...
	public String execute() throws DbManagerException, SigitTIspezione2018DaoException {
		...
		try {
			ArrayList<RisultatoRicImpianto> ris= (ArrayList<RisultatoRicImpianto>) session.get("appDataelencoAllegati");
			LOG.debug("RIS: "+ ris);
			...
			String[] headers = {"codice impianto","comune","indirizzo","manutentore","stato","tipo","data controllo","sigla REE","numero REE","elenco apparecchiature"};
			String[] fields = {"codiceImpianto","comune","indirizzo","manutentore","statoAllegato","tipoAllegato","dataControllo","siglaBollino","numeroBollino","elencoApparecchiature"};
