package it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda9_3;
...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_3.CpGestLibScheda9_3DettModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda9_3.states.CpGestLibScheda9_3DettScreenStates;
...
/**
 * CpGestLibScheda9_3DettAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda9_3DettAction extends AbstractCPAction<CpGestLibScheda9_3DettModel>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda9_3DettModel> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda9_3DettModel model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda9_3DettModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda9_3DettModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda9_3DettModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda9_3Dett";

	/**
	 * nome del namespace che contiene il content panel
	 */
	private static final String CP_NAMESPACE = "gestisci_libretto_scheda9_3";

	/**
	 * nome completo del namespace che contiene il content panel
	 */
	private static final String CP_FULL_NAMESPACE = "/base/gestisci_libretto_scheda9_3";
	...
	private static final String URL_BACK_COMMAND = "/base/gestisci_libretto_scheda9_3/" + CP_NAME;

	/**
	 * classe model associata al ContentPanel
	 */
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_3.CpGestLibScheda9_3DettModel.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_3", "cpgestlibscheda9_3dett", "menuLibretto", "CLICKED");
	...
	public String handleBtSostComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_3", "cpgestlibscheda9_3dett", "btSostComp", "CLICKED");
	...
	public String handleBtDismettiComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_3", "cpgestlibscheda9_3dett", "btDismettiComp",
				"CLICKED");
	...
	public String handleBtRiattivaComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_3", "cpgestlibscheda9_3dett", "btRiattivaComp",
				"CLICKED");
	...
	public String handleTbComponenti_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_3", "cpgestlibscheda9_3dett", "tbComponenti", "CLICKED");
	...
	public String handleBtRipristina_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_3", "cpgestlibscheda9_3dett", "btRipristina", "CLICKED");
	...
	public String handleBtSalva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_3", "cpgestlibscheda9_3dett", "btSalva", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_3", "cpgestlibscheda9_3dett", "btnIndietro", "CLICKED");
	...
	public String provideTbComponenti_DATASET() throws CommandExecutionException {
		...
		return provideDataInternal("appDatalistaComponentiSCX", "", false, false);
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R891812788) ENABLED START*/
