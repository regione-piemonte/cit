...
public class RecuperaLibrettoNow extends BaseAction<BaseSessionAwareDTO> {
	...
	public String execute()
	{
		...
		try
		{
			...
			String idPersonaGiuridica = ConvertUtil.convertToString(utenteLoggato.getRuolo().getIdPersonaGiuridica());
			
			DettaglioDocumento allegato = getServiziMgr().getLibrettoPdfNow(idImpianto, false, utenteLoggato.getCodiceFiscale(), idPersonaGiuridica);
