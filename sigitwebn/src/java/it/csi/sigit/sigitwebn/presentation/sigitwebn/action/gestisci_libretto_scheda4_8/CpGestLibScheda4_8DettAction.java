package it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda4_8;
...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_8.CpGestLibScheda4_8DettModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda4_8.states.CpGestLibScheda4_8DettScreenStates;
...
/**
 * CpGestLibScheda4_8DettAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda4_8DettAction extends AbstractCPAction<CpGestLibScheda4_8DettModel>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda4_8DettModel> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda4_8DettModel model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda4_8DettModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda4_8DettModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda4_8DettModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda4_8Dett";

	/**
	 * nome del namespace che contiene il content panel
	 */
	private static final String CP_NAMESPACE = "gestisci_libretto_scheda4_8";

	/**
	 * nome completo del namespace che contiene il content panel
	 */
	private static final String CP_FULL_NAMESPACE = "/base/gestisci_libretto_scheda4_8";
	...
	private static final String URL_BACK_COMMAND = "/base/gestisci_libretto_scheda4_8/" + CP_NAME;

	/**
	 * classe model associata al ContentPanel
	 */
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_8.CpGestLibScheda4_8DettModel.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_8", "cpgestlibscheda4_8dett", "menuLibretto", "CLICKED");
	...
	public String handleBtSostComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_8", "cpgestlibscheda4_8dett", "btSostComp", "CLICKED");
	...
	public String handleBtDismettiComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_8", "cpgestlibscheda4_8dett", "btDismettiComp",
				"CLICKED");
	...
	public String handleBtRiattivaComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_8", "cpgestlibscheda4_8dett", "btRiattivaComp",
				"CLICKED");
	...
	public String handleTbComponenti_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_8", "cpgestlibscheda4_8dett", "tbComponenti", "CLICKED");
	...
	public String handleBtRipristina_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_8", "cpgestlibscheda4_8dett", "btRipristina", "CLICKED");
	...
	public String handleBtSalva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_8", "cpgestlibscheda4_8dett", "btSalva", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_8", "cpgestlibscheda4_8dett", "btnIndietro", "CLICKED");
	...
	public String provideTbComponenti_DATASET() throws CommandExecutionException {
		...
		return provideDataInternal("appDatalistaComponentiAG", "", false, false);
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R448038516) ENABLED START*/
