...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_1.CpGestLibScheda9_1DettModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda9_1.states.CpGestLibScheda9_1DettScreenStates;
...
/**
 * CpGestLibScheda9_1DettAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda9_1DettAction extends AbstractCPAction<CpGestLibScheda9_1DettModel>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda9_1DettModel> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda9_1DettModel model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda9_1DettModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda9_1DettModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda9_1DettModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda9_1Dett";
	...
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_1.CpGestLibScheda9_1DettModel.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_1", "cpgestlibscheda9_1dett", "menuLibretto", "CLICKED");
	...
	public String handleBtSostComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_1", "cpgestlibscheda9_1dett", "btSostComp", "CLICKED");
	...
	public String handleBtDismettiComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_1", "cpgestlibscheda9_1dett", "btDismettiComp",
				"CLICKED");
	...
	public String handleBtRiattivaComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_1", "cpgestlibscheda9_1dett", "btRiattivaComp",
				"CLICKED");
	...
	public String handleTbComponenti_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_1", "cpgestlibscheda9_1dett", "tbComponenti", "CLICKED");
	...
	public String handleBtRipristina_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_1", "cpgestlibscheda9_1dett", "btRipristina", "CLICKED");
	...
	public String handleBtSalva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_1", "cpgestlibscheda9_1dett", "btSalva", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_1", "cpgestlibscheda9_1dett", "btnIndietro", "CLICKED");
	...
	public String provideTbComponenti_DATASET() throws CommandExecutionException {
		...
		return provideDataInternal("appDatalistaComponentiTE", "", false, false);
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R1709461238) ENABLED START*/
