package it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda9_5;
...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_5.CpGestLibScheda9_5DettModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda9_5.states.CpGestLibScheda9_5DettScreenStates;
...
/**
 * CpGestLibScheda9_5DettAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda9_5DettAction extends AbstractCPAction<CpGestLibScheda9_5DettModel>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda9_5DettModel> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda9_5DettModel model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda9_5DettModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda9_5DettModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda9_5DettModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda9_5Dett";

	/**
	 * nome del namespace che contiene il content panel
	 */
	private static final String CP_NAMESPACE = "gestisci_libretto_scheda9_5";

	/**
	 * nome completo del namespace che contiene il content panel
	 */
	private static final String CP_FULL_NAMESPACE = "/base/gestisci_libretto_scheda9_5";
	...
	private static final String URL_BACK_COMMAND = "/base/gestisci_libretto_scheda9_5/" + CP_NAME;

	/**
	 * classe model associata al ContentPanel
	 */
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_5.CpGestLibScheda9_5DettModel.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_5", "cpgestlibscheda9_5dett", "menuLibretto", "CLICKED");
	...
	public String handleBtSostComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_5", "cpgestlibscheda9_5dett", "btSostComp", "CLICKED");
	...
	public String handleBtDismettiComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_5", "cpgestlibscheda9_5dett", "btDismettiComp",
				"CLICKED");
	...
	public String handleBtRiattivaComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_5", "cpgestlibscheda9_5dett", "btRiattivaComp",
				"CLICKED");
	...
	public String handleTbComponenti_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_5", "cpgestlibscheda9_5dett", "tbComponenti", "CLICKED");
	...
	public String handleBtRipristina_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_5", "cpgestlibscheda9_5dett", "btRipristina", "CLICKED");
	...
	public String handleBtSalva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_5", "cpgestlibscheda9_5dett", "btSalva", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_5", "cpgestlibscheda9_5dett", "btnIndietro", "CLICKED");
	...
	public String provideTbComponenti_DATASET() throws CommandExecutionException {
		...
		return provideDataInternal("appDatalistaComponentiUT", "", false, false);
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R74164338) ENABLED START*/
