...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda8.CpGestLibScheda8Model;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda8.states.CpGestLibScheda8ScreenStates;
...
/**
 * CpGestLibScheda8Action Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda8Action extends AbstractCPAction<CpGestLibScheda8Model>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda8Model> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda8Model model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda8Model getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda8Model modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda8Model();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda8";
	...
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda8.CpGestLibScheda8Model.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8", "menuLibretto", "CLICKED");
	...
	public String handleBtNuovo_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8", "btNuovo", "CLICKED");
	...
	public String handleBtDettaglio_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8", "btDettaglio", "CLICKED");
	...
	public String handleBtElimina_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8", "btElimina", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8", "btnIndietro", "CLICKED");
	...
	public String handleBtConfermaElim_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8", "btConfermaElim", "CLICKED");
	...
	public String handleBtAnnullaElim_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8", "btAnnullaElim", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R-607367542) ENABLED START*/
