...
public class ShowRicevutaAllegato extends BaseAction<BaseSessionAwareDTO> {
...
//		String contentDisp = "inline;filename=ricevutaAllegato.pdf";
		...
		String contentDisp = "attachment;filename=ricevutaAllegato.pdf";
...
//			byte[] libretto = getModuloBuilder().showRicevutaAllegato();
			byte[] libretto = getRicevutaBuilder().generaRicevutaAllegato(idAllegato);
			
			LOG.debug("STAMPO IL LIBRETTO: "+libretto);
