...
public class ExportExcelElencoAllegati extends BaseAction<BaseSessionAwareDTO> {
	...
	public String execute() throws DbManagerException, SigitTIspezione2018DaoException {
		...
		try {
			ArrayList<RisultatoRicImpianto> ris= (ArrayList<RisultatoRicImpianto>) session.get("appDataelencoAllegatiPerImpianto");
			LOG.debug("RIS: "+ ris);
			File exportTemplateTempFile = File.createTempFile("export_elenco_allegati", ".xlsx");
			...
			String[] headers = {"data controllo","tipo REE","stato REE","osservazioni","raccomandazioni","prescrizioni","intervento entro","elenco apparecchiature","firmato"};
			String[] fields = {"dataControllo","tipoAllegato","statoAllegato","osservazioni","raccomandazioni","prescrizioni","interventoRaccomandato","elencoApparecchiature","flgFirmato"};
