...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_6.CpGestLibScheda4_6DettModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda4_6.states.CpGestLibScheda4_6DettScreenStates;
...
/**
 * CpGestLibScheda4_6DettAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda4_6DettAction extends AbstractCPAction<CpGestLibScheda4_6DettModel>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda4_6DettModel> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda4_6DettModel model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda4_6DettModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda4_6DettModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda4_6DettModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda4_6Dett";
	...
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_6.CpGestLibScheda4_6DettModel.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_6", "cpgestlibscheda4_6dett", "menuLibretto", "CLICKED");
	...
	public String handleBSostituisciComponente_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_6", "cpgestlibscheda4_6dett", "bSostituisciComponente",
				"CLICKED");
	...
	public String handleBDismettiComponente_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_6", "cpgestlibscheda4_6dett", "bDismettiComponente",
				"CLICKED");
	...
	public String handleBRiattivaComponente_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_6", "cpgestlibscheda4_6dett", "bRiattivaComponente",
				"CLICKED");
	...
	public String handleTbSostituzioni_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_6", "cpgestlibscheda4_6dett", "tbSostituzioni",
				"CLICKED");
	...
	public String handleBtRipristinaAttualeDett_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_6", "cpgestlibscheda4_6dett", "btRipristinaAttualeDett",
				"CLICKED");
	...
	public String handleBtSalvaDett_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_6", "cpgestlibscheda4_6dett", "btSalvaDett", "CLICKED");
	...
	public String handleBtIndietroDett_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_6", "cpgestlibscheda4_6dett", "btIndietroDett",
				"CLICKED");
	...
	/**
	 * Prepara l'input stream referenziato dal result "provideData" con i valori relativi 
	 * al data-binding relativo al dataset DATASET del widget cbAlimentazione.
	 * @return sempre il result "provideData"
	 */
	@SkipValidation
	@FatClientOnly
	public String provideCbAlimentazione_DATASET() throws CommandExecutionException {
	...
	public String provideTbSostituzioni_DATASET() throws CommandExecutionException {
		...
		return provideDataInternal("appDatalistaStoricoComponentiCG", "", false, false);
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R1265686966) ENABLED START*/
