...
import it.csi.sigit.sigitwebn.dto.gestisci_rapprova.CpGestRapProvaTipo2Model;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_rapprova.states.CpGestRapProvaTipo2ScreenStates;
...
/**
 * CpGestRapProvaTipo2Action Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestRapProvaTipo2Action extends AbstractCPAction<CpGestRapProvaTipo2Model>
		implements
			Preparable,
			ModelDriven<CpGestRapProvaTipo2Model> {
	 ...
	 * strato di business.
	 */
	private CpGestRapProvaTipo2Model model;
	 ...
	 * strato di business.
	 */
	public CpGestRapProvaTipo2Model getModel() {
		return model;
	}
	...
	public void setModel(CpGestRapProvaTipo2Model modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestRapProvaTipo2Model();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestRapProvaTipo2";
	...
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_rapprova.CpGestRapProvaTipo2Model.class;
	}
	...
	public String handleMenuRapProva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_rapprova", "cpgestrapprovatipo2", "menuRapProva", "CLICKED");
	...
	public String handleBSalvaRapProva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_rapprova", "cpgestrapprovatipo2", "bSalvaRapProva", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_rapprova", "cpgestrapprovatipo2", "btnIndietro", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R1030047428) ENABLED START*/
