...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_4.CpGestLibScheda9_4Model;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda9_4.states.CpGestLibScheda9_4ScreenStates;
...
/**
 * CpGestLibScheda9_4Action Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda9_4Action extends AbstractCPAction<CpGestLibScheda9_4Model>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda9_4Model> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda9_4Model model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda9_4Model getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda9_4Model modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda9_4Model();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda9_4";
	...
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_4.CpGestLibScheda9_4Model.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_4", "cpgestlibscheda9_4", "menuLibretto", "CLICKED");
	...
	public String handleBtNuovo_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_4", "cpgestlibscheda9_4", "btNuovo", "CLICKED");
	...
	public String handleBtDettaglio_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_4", "cpgestlibscheda9_4", "btDettaglio", "CLICKED");
	...
	public String handleBtElimina_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_4", "cpgestlibscheda9_4", "btElimina", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_4", "cpgestlibscheda9_4", "btnIndietro", "CLICKED");
	...
	public String handleBtConfermaElim_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_4", "cpgestlibscheda9_4", "btConfermaElim", "CLICKED");
	...
	public String handleBtAnnullaElim_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_4", "cpgestlibscheda9_4", "btAnnullaElim", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R838067604) ENABLED START*/
