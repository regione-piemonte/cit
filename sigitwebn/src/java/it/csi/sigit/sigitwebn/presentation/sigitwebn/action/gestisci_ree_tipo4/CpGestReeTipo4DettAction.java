...
import it.csi.sigit.sigitwebn.dto.gestisci_ree_tipo4.CpGestReeTipo4DettModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_ree_tipo4.states.CpGestReeTipo4DettScreenStates;
...
/**
 * CpGestReeTipo4DettAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestReeTipo4DettAction extends AbstractCPAction<CpGestReeTipo4DettModel>
		implements
			Preparable,
			ModelDriven<CpGestReeTipo4DettModel> {
	 ...
	 * strato di business.
	 */
	private CpGestReeTipo4DettModel model;
	 ...
	 * strato di business.
	 */
	public CpGestReeTipo4DettModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestReeTipo4DettModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestReeTipo4DettModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestReeTipo4Dett";
	...
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_ree_tipo4.CpGestReeTipo4DettModel.class;
	}
	...
	public String handleMenuRee_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_tipo4", "cpgestreetipo4dett", "menuRee", "CLICKED");
	...
	public String handleBSalvaReeDett_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_tipo4", "cpgestreetipo4dett", "bSalvaReeDett", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_tipo4", "cpgestreetipo4dett", "btnIndietro", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R-1960002172) ENABLED START*/
