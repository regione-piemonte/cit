package it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_ree_documenti;
...
import it.csi.sigit.sigitwebn.dto.gestisci_ree_documenti.CpGestisciReeDocumentiModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_ree_documenti.states.CpGestisciReeDocumentiScreenStates;
...
/**
 * CpGestisciReeDocumentiAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestisciReeDocumentiAction extends AbstractCPAction<CpGestisciReeDocumentiModel>
		implements
			Preparable,
			ModelDriven<CpGestisciReeDocumentiModel> {
	 ...
	 * strato di business.
	 */
	private CpGestisciReeDocumentiModel model;
	 ...
	 * strato di business.
	 */
	public CpGestisciReeDocumentiModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestisciReeDocumentiModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestisciReeDocumentiModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestisciReeDocumenti";

	/**
	 * nome del namespace che contiene il content panel
	 */
	private static final String CP_NAMESPACE = "gestisci_ree_documenti";

	/**
	 * nome completo del namespace che contiene il content panel
	 */
	private static final String CP_FULL_NAMESPACE = "/base/gestisci_ree_documenti";
	...
	private static final String URL_BACK_COMMAND = "/base/gestisci_ree_documenti/" + CP_NAME;

	/**
	 * classe model associata al ContentPanel
	 */
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_ree_documenti.CpGestisciReeDocumentiModel.class;
	}
	...
	public String handleMenuRee_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_documenti", "cpgestiscireedocumenti", "menuRee", "CLICKED");
	...
	public String handleBtnVisualizzaDoc_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_documenti", "cpgestiscireedocumenti", "btnVisualizzaDoc", "CLICKED");
	...
	public String handleBtnInserisciDocumento_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_documenti", "cpgestiscireedocumenti", "btnInserisciDocumento",
				"CLICKED");
	...
	public String handleBtnEliminaDocumento_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_documenti", "cpgestiscireedocumenti", "btnEliminaDocumento",
				"CLICKED");
	...
	public String handleBtnIndietroElencoAllegatiImpianti_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_documenti", "cpgestiscireedocumenti",
	...
	public String handleBtnChiudiDatiDocumento_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_documenti", "cpgestiscireedocumenti", "btnChiudiDatiDocumento",
				"CLICKED");
	...
	public String handleBtnCaricaDocumento_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_documenti", "cpgestiscireedocumenti", "btnCaricaDocumento", "CLICKED");
	...
	public String handleBtConfermaElim_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_documenti", "cpgestiscireedocumenti", "btConfermaElim", "CLICKED");
	...
	public String handleBtAnnullaElim_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_documenti", "cpgestiscireedocumenti", "btAnnullaElim", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R-1934253433) ENABLED START*/
