package it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda5_1vr;
...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_1vr.CpGestLibScheda5_1VRDettModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda5_1vr.states.CpGestLibScheda5_1VRDettScreenStates;
...
/**
 * CpGestLibScheda5_1VRDettAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda5_1VRDettAction extends AbstractCPAction<CpGestLibScheda5_1VRDettModel>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda5_1VRDettModel> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda5_1VRDettModel model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda5_1VRDettModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda5_1VRDettModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda5_1VRDettModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda5_1VRDett";

	/**
	 * nome del namespace che contiene il content panel
	 */
	private static final String CP_NAMESPACE = "gestisci_libretto_scheda5_1VR";

	/**
	 * nome completo del namespace che contiene il content panel
	 */
	private static final String CP_FULL_NAMESPACE = "/base/gestisci_libretto_scheda5_1VR";
	...
	private static final String URL_BACK_COMMAND = "/base/gestisci_libretto_scheda5_1VR/" + CP_NAME;

	/**
	 * classe model associata al ContentPanel
	 */
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_1vr.CpGestLibScheda5_1VRDettModel.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1vr", "cpgestlibscheda5_1vrdett", "menuLibretto",
				"CLICKED");
	...
	public String handleBtSostComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1vr", "cpgestlibscheda5_1vrdett", "btSostComp",
				"CLICKED");
	...
	public String handleBtDismettiComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1vr", "cpgestlibscheda5_1vrdett", "btDismettiComp",
				"CLICKED");
	...
	public String handleBtRiattivaComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1vr", "cpgestlibscheda5_1vrdett", "btRiattivaComp",
				"CLICKED");
	...
	public String handleTbComponenti_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1vr", "cpgestlibscheda5_1vrdett", "tbComponenti",
				"CLICKED");
	...
	public String handleBtRipristina_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1vr", "cpgestlibscheda5_1vrdett", "btRipristina",
				"CLICKED");
	...
	public String handleBtSalva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1vr", "cpgestlibscheda5_1vrdett", "btSalva", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1vr", "cpgestlibscheda5_1vrdett", "btnIndietro",
				"CLICKED");
	...
	public String provideTbComponenti_DATASET() throws CommandExecutionException {
		...
		return provideDataInternal("appDatalistaComponentiVR", "", false, false);
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R-2128883394) ENABLED START*/
