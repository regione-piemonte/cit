package it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda9_2;
...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_2.CpGestLibScheda9_2DettModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda9_2.states.CpGestLibScheda9_2DettScreenStates;
...
/**
 * CpGestLibScheda9_2DettAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda9_2DettAction extends AbstractCPAction<CpGestLibScheda9_2DettModel>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda9_2DettModel> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda9_2DettModel model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda9_2DettModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda9_2DettModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda9_2DettModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda9_2Dett";

	/**
	 * nome del namespace che contiene il content panel
	 */
	private static final String CP_NAMESPACE = "gestisci_libretto_scheda9_2";

	/**
	 * nome completo del namespace che contiene il content panel
	 */
	private static final String CP_FULL_NAMESPACE = "/base/gestisci_libretto_scheda9_2";
	...
	private static final String URL_BACK_COMMAND = "/base/gestisci_libretto_scheda9_2/" + CP_NAME;

	/**
	 * classe model associata al ContentPanel
	 */
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_2.CpGestLibScheda9_2DettModel.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_2", "cpgestlibscheda9_2dett", "menuLibretto", "CLICKED");
	...
	public String handleBtSostComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_2", "cpgestlibscheda9_2dett", "btSostComp", "CLICKED");
	...
	public String handleBtDismettiComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_2", "cpgestlibscheda9_2dett", "btDismettiComp",
				"CLICKED");
	...
	public String handleBtRiattivaComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_2", "cpgestlibscheda9_2dett", "btRiattivaComp",
				"CLICKED");
	...
	public String handleTbComponenti_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_2", "cpgestlibscheda9_2dett", "tbComponenti", "CLICKED");
	...
	public String handleBtRipristina_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_2", "cpgestlibscheda9_2dett", "btRipristina", "CLICKED");
	...
	public String handleBtSalva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_2", "cpgestlibscheda9_2dett", "btSalva", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda9_2", "cpgestlibscheda9_2dett", "btnIndietro", "CLICKED");
	...
	public String provideTbComponenti_DATASET() throws CommandExecutionException {
		...
		return provideDataInternal("appDatalistaComponentiRV", "", false, false);
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R1300637013) ENABLED START*/
