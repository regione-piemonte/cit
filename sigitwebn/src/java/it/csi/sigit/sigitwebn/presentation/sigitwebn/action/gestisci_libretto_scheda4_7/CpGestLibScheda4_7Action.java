...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_7.CpGestLibScheda4_7Model;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda4_7.states.CpGestLibScheda4_7ScreenStates;
...
/**
 * CpGestLibScheda4_7Action Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda4_7Action extends AbstractCPAction<CpGestLibScheda4_7Model>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda4_7Model> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda4_7Model model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda4_7Model getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda4_7Model modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda4_7Model();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda4_7";
	...
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_7.CpGestLibScheda4_7Model.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_7", "cpgestlibscheda4_7", "menuLibretto", "CLICKED");
	...
	public String handleBtNuovo_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_7", "cpgestlibscheda4_7", "btNuovo", "CLICKED");
	...
	public String handleBtDettaglio_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_7", "cpgestlibscheda4_7", "btDettaglio", "CLICKED");
	...
	public String handleBtElimina_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_7", "cpgestlibscheda4_7", "btElimina", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_7", "cpgestlibscheda4_7", "btnIndietro", "CLICKED");
	...
	public String handleBtConfermaElim_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_7", "cpgestlibscheda4_7", "btConfermaElim", "CLICKED");
	...
	public String handleBtAnnullaElim_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda4_7", "cpgestlibscheda4_7", "btAnnullaElim", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R-3140458) ENABLED START*/
