...
import it.csi.sigit.sigitwebn.dto.gestisci_azioni.CpSvegliaModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_azioni.states.CpSvegliaScreenStates;
...
/**
 * CpSvegliaAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpSvegliaAction extends AbstractCPAction<CpSvegliaModel>
		implements
			Preparable,
			ModelDriven<CpSvegliaModel> {
	 ...
	 * strato di business.
	 */
	public CpSvegliaModel getModel() {
		return model;
	}
	...
	public void setModel(CpSvegliaModel modello) {
		this.model = modello;
	}
	 ...
	 */
	private static final String CP_NAME = "cpSveglia";
	...
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_azioni.CpSvegliaModel.class;
	}
	...
	public String handleBtSalva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_azioni", "cpsveglia", "btSalva", "CLICKED");
	...
	public String handleBtElimina_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_azioni", "cpsveglia", "btElimina", "CLICKED");
	...
	public String handleBtIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_azioni", "cpsveglia", "btIndietro", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R267954637) ENABLED START*/
