package it.csi.sigit.sigitwebn.presentation.sigitwebn.command;
...
public class CommandFactory {
	...
	private static final String RESOURCE_BASE = "/it/csi/sigit/sigitwebn/presentation/sigitwebn/action";
