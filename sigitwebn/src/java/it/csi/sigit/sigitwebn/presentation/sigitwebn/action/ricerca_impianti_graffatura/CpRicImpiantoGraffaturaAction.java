package it.csi.sigit.sigitwebn.presentation.sigitwebn.action.ricerca_impianti_graffatura;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.ricerca_impianti_graffatura.states.CpRicImpiantoGraffaturaScreenStates;
...
/**
 * CpRicImpiantoGraffaturaAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpRicImpiantoGraffaturaAction extends AbstractCPAction<CpRicImpiantoGraffaturaModel>
		implements
			Preparable,
			ModelDriven<CpRicImpiantoGraffaturaModel> {
	 ...
	 * strato di business.
	 */
	private CpRicImpiantoGraffaturaModel model;
	 ...
	 * strato di business.
	 */
	public CpRicImpiantoGraffaturaModel getModel() {
		return model;
	}
	...
	public void setModel(CpRicImpiantoGraffaturaModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpRicImpiantoGraffaturaModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpRicImpiantoGraffatura";

	/**
	 * nome del namespace che contiene il content panel
	 */
	private static final String CP_NAMESPACE = "ricerca_impianti_graffatura";

	/**
	 * nome completo del namespace che contiene il content panel
	 */
	private static final String CP_FULL_NAMESPACE = "/base/ricerca_impianti_graffatura";
	...
	private static final String URL_BACK_COMMAND = "/base/ricerca_impianti_graffatura/" + CP_NAME;

	/**
	 * classe model associata al ContentPanel
	 */
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.ricerca_impianti_graffatura.CpRicImpiantoGraffaturaModel.class;
	}
	...
	public String handleCbProvincia_VALUE_CHANGED() throws CommandExecutionException {
		...
		return handleEventInternal("ricerca_impianti_graffatura", "cpricimpiantograffatura", "cbProvincia",
				"VALUE_CHANGED");
	...
	public String handleBtRicIns_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricerca_impianti_graffatura", "cpricimpiantograffatura", "btRicIns", "CLICKED");
	...
	public String handleBtIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricerca_impianti_graffatura", "cpricimpiantograffatura", "btIndietro", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R-1130862464) ENABLED START*/
