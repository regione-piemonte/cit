...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_1sr.CpGestLibScheda5_1SRModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda5_1sr.states.CpGestLibScheda5_1SRScreenStates;
...
/**
 * CpGestLibScheda5_1SRAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda5_1SRAction extends AbstractCPAction<CpGestLibScheda5_1SRModel>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda5_1SRModel> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda5_1SRModel model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda5_1SRModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda5_1SRModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda5_1SRModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda5_1SR";
	...
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_1sr.CpGestLibScheda5_1SRModel.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1sr", "cpgestlibscheda5_1sr", "menuLibretto", "CLICKED");
	...
	public String handleBtNuovo_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1sr", "cpgestlibscheda5_1sr", "btNuovo", "CLICKED");
	...
	public String handleBtDettaglio_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1sr", "cpgestlibscheda5_1sr", "btDettaglio", "CLICKED");
	...
	public String handleBtElimina_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1sr", "cpgestlibscheda5_1sr", "btElimina", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1sr", "cpgestlibscheda5_1sr", "btnIndietro", "CLICKED");
	...
	public String handleBtConfermaElim_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1sr", "cpgestlibscheda5_1sr", "btConfermaElim",
				"CLICKED");
	...
	public String handleBtAnnullaElim_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda5_1sr", "cpgestlibscheda5_1sr", "btAnnullaElim", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R-1830512580) ENABLED START*/
