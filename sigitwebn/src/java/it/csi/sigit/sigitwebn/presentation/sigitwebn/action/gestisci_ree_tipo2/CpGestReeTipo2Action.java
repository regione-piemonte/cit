...
import it.csi.sigit.sigitwebn.dto.gestisci_ree_tipo2.CpGestReeTipo2Model;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_ree_tipo2.states.CpGestReeTipo2ScreenStates;
...
/**
 * CpGestReeTipo2Action Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestReeTipo2Action extends AbstractCPAction<CpGestReeTipo2Model>
		implements
			Preparable,
			ModelDriven<CpGestReeTipo2Model> {
	 ...
	 * strato di business.
	 */
	private CpGestReeTipo2Model model;
	 ...
	 * strato di business.
	 */
	public CpGestReeTipo2Model getModel() {
		return model;
	}
	...
	public void setModel(CpGestReeTipo2Model modello) {
		this.model = modello;
	}
	 ...
	 */
	private static final String CP_NAME = "cpGestReeTipo2";
	...
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_ree_tipo2.CpGestReeTipo2Model.class;
	}
	...
	public String handleMenuRee_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_tipo2", "cpgestreetipo2", "menuRee", "CLICKED");
	...
	public String handleBSalvaRee_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_tipo2", "cpgestreetipo2", "bSalvaRee", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_ree_tipo2", "cpgestreetipo2", "btnIndietro", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R755791303) ENABLED START*/
