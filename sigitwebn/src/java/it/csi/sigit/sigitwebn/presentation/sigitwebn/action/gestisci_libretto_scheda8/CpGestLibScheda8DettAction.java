package it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda8;
...
import it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda8.CpGestLibScheda8DettModel;
...
import it.csi.sigit.sigitwebn.presentation.sigitwebn.action.gestisci_libretto_scheda8.states.CpGestLibScheda8DettScreenStates;
...
/**
 * CpGestLibScheda8DettAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestLibScheda8DettAction extends AbstractCPAction<CpGestLibScheda8DettModel>
		implements
			Preparable,
			ModelDriven<CpGestLibScheda8DettModel> {
	 ...
	 * strato di business.
	 */
	private CpGestLibScheda8DettModel model;
	 ...
	 * strato di business.
	 */
	public CpGestLibScheda8DettModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestLibScheda8DettModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestLibScheda8DettModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestLibScheda8Dett";

	/**
	 * nome del namespace che contiene il content panel
	 */
	private static final String CP_NAMESPACE = "gestisci_libretto_scheda8";

	/**
	 * nome completo del namespace che contiene il content panel
	 */
	private static final String CP_FULL_NAMESPACE = "/base/gestisci_libretto_scheda8";
	...
	private static final String URL_BACK_COMMAND = "/base/gestisci_libretto_scheda8/" + CP_NAME;

	/**
	 * classe model associata al ContentPanel
	 */
	public Class modelClass() {
		return it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda8.CpGestLibScheda8DettModel.class;
	}
	...
	public String handleMenuLibretto_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8dett", "menuLibretto", "CLICKED");
	...
	public String handleBtSostComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8dett", "btSostComp", "CLICKED");
	...
	public String handleBtDismettiComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8dett", "btDismettiComp", "CLICKED");
	...
	public String handleBtRiattivaComp_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8dett", "btRiattivaComp", "CLICKED");
	...
	public String handleTbComponenti_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8dett", "tbComponenti", "CLICKED");
	...
	public String handleBtRipristina_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8dett", "btRipristina", "CLICKED");
	...
	public String handleBtSalva_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8dett", "btSalva", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestisci_libretto_scheda8", "cpgestlibscheda8dett", "btnIndietro", "CLICKED");
	...
	public String provideTbComponenti_DATASET() throws CommandExecutionException {
		...
		return provideDataInternal("appDatalistaComponentiAC", "", false, false);
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R-507981815) ENABLED START*/
