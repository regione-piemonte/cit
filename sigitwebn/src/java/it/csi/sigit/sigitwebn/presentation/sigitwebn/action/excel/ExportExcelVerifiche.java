...
public class ExportExcelVerifiche extends BaseAction<BaseSessionAwareDTO> {
	...
	public String execute() throws DbManagerException, SigitTIspezione2018DaoException {
		...
		try {
			ArrayList<Verifica> ris= (ArrayList<Verifica>) session.get("appDataelencoVerifiche");
			LOG.debug("RIS: "+ ris);
			...
			String[] headers = {"identificativo","caricato da","data creazione","tipo verifica","codice impianto","REE","id. dato distrib"};
			String[] fields = {"identificativo","eseguitoDa","dataCaricamento","descrizioneTipoVerifica","codiceImpianto","risultatoBollino","idDatoDistributore"};
