...
/*PROTECTED REGION ID(R196451656) ENABLED START*/
...
public class CPBECpGestLibScheda6_4Dett {
	...
	// ApplicationData: [componentePO, scope:USER_SESSION]
	public static final String APPDATA_COMPONENTEPO_CODE = "appDatacomponentePO";

	// ApplicationData: [listaComponentiPO, scope:USER_SESSION]
	public static final String APPDATA_LISTACOMPONENTIPO_CODE = "appDatalistaComponentiPO";
	...
	public static final String CPNAME = "cpGestLibScheda6_4Dett";
	 ...
	 * ContentPanel cpGestLibScheda6_4Dett
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda6_4.CpGestLibScheda6_4DettModel theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R832845370) ENABLED START*/
	...
	public ExecResults sostituisciComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1759296697) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			try {
				ComponentePO componente = theModel.getAppDatacomponentePO();
				ArrayList<ComponentePO> compList = theModel.getAppDatalistaComponentiPO();

				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda6_4Dett(componente, compList, true);
	...
	public ExecResults dismettiComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R356713473) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				theModel.setAppDatacomponentePO(componente);
	...
	public ExecResults rollbackComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R415585216) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults attivaColonna(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1472666970) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults ripristinaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-260181511) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazioneRipristina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R742437066) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R637728845) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda6_4Dett(componente, compList, false);
				...
				getDbMgr().salvaComponentePO(codImpiantoSelez, componente, compList, utente.getCodiceFiscale());
	...
	public ExecResults gestisciIndietro(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-81251186) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-721395989) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponenteDett(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1945137170) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			if (theModel.getAppDataelencoSiNo() == null) {
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R644062591) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			UtenteLoggato utente = theModel.getAppDatautenteLoggato();

			if (GenericUtil.isUtenteAutorLibWebScheda6_4(utente)) {
				// impostazione del result code 
	...
	public ExecResults gestisciVisualizzazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1897766891) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R769171027) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda6_4Dett_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R204723116) ENABLED START*/
	...
	private void recuperaComponenteDett(
		...
		if (isNuovoComponente) {
			...
			ComponentePO compPO = new ComponentePO();

			progressivo++;

			compPO.setIdComponente(Constants.TIPO_COMPONENTE_PO + Constants.INTERVAL_SEP + progressivo);
			compPO.setIdTipoComponente(Constants.TIPO_COMPONENTE_PO);
			compPO.setProgrComponente(ConvertUtil.convertToString(progressivo));

			theModel.setAppDatacomponentePO(compPO);
			theModel.setAppDatalistaComponentiPO(null);
	...
	private void compilaComponente(String codImpianto, int progressivo,
		...
		try {
			...
			ComponentePO componentePO = MapDto.mapToComponentePrincPO(compList);
			theModel.setAppDatacomponentePO(componentePO);

			// Il primo elemento delle sostituzioni e' ripristinabile se l'utente e' abilitato e se l'elemento attuale non e' dismesso 
			boolean isRipristinabile = GenericUtil.isUtenteAutorLibWebScheda6_4(theModel.getAppDatautenteLoggato())
					&& !componentePO.getFlgDismesso();

			theModel.setAppDatalistaComponentiPO(MapDto.mapToComponenteSostPO(compList, isRipristinabile));
	...
	private void sostituisciComponente(ComponentePO componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda6_4.CpGestLibScheda6_4DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			if (compList == null) {
				compList = new ArrayList<ComponentePO>();
				theModel.setAppDatalistaComponentiPO(compList);
			}

			compList.add(0, componente);

			ComponentePO componenteNew = new ComponentePO();
			...
			theModel.setAppDatacomponentePO(componenteNew);
	...
	private void riattivaComponente(ComponentePO componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda6_4.CpGestLibScheda6_4DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			ComponentePO componenteNew = compList.get(0);
