package it.csi.sigit.sigitwebn.business.gestisci_libretto_scheda9_6;
...
/*PROTECTED REGION ID(R1854568931) ENABLED START*/
import it.csi.sigit.sigitwebn.business.dao.sigitwebn.dto.SigitVCompRcDto;
...
public class CPBECpGestLibScheda9_6Dett {
	...
	// ApplicationData: [componenteRC, scope:USER_SESSION]
	public static final String APPDATA_COMPONENTERC_CODE = "appDatacomponenteRC";

	// ApplicationData: [listaComponentiRC, scope:USER_SESSION]
	public static final String APPDATA_LISTACOMPONENTIRC_CODE = "appDatalistaComponentiRC";

	// ApplicationData: [elencoTipoInstallazione, scope:USER_SESSION]
	public static final String APPDATA_ELENCOTIPOINSTALLAZIONE_CODE = "appDataelencoTipoInstallazione";
	...
	public static final String CPNAME = "cpGestLibScheda9_6Dett";
	 ...
	 * ContentPanel cpGestLibScheda9_6Dett
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_6.CpGestLibScheda9_6DettModel theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R-879866603) ENABLED START*/
	...
	public ExecResults sostituisciComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1071246868) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			try {
				ComponenteRC componente = theModel.getAppDatacomponenteRC();
				ArrayList<ComponenteRC> compList = theModel.getAppDatalistaComponentiRC();

				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda9_6Dett(componente, compList, true);
	...
	public ExecResults dismettiComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1197750138) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				theModel.setAppDatacomponenteRC(componente);
	...
	public ExecResults rollbackComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1138878395) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults attivaColonna(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1878568641) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults ripristinaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R548907326) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazioneRipristina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-700161691) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R162204136) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda9_6Dett(componente, compList, false);
				...
				getDbMgr().salvaComponenteRC(codImpiantoSelez, componente, compList, utente.getCodiceFiscale());
	...
	public ExecResults gestisciIndietro(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R64040595) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-576104208) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponenteDett(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1410243529) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			if (theModel.getAppDataelencoTipoInstallazione() == null) {
				theModel.setAppDataelencoTipoInstallazione(GenericUtil.getComboTipoInstallazione());
			}
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1581649156) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-428734864) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-943540946) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda9_6Dett_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R757591345) ENABLED START*/
	...
	private void recuperaComponenteDett(
		...
		if (isNuovoComponente) {
			...
			ComponenteRC comp = new ComponenteRC();

			progressivo++;

			comp.setIdComponente(Constants.TIPO_COMPONENTE_RC + Constants.INTERVAL_SEP + progressivo);
			comp.setIdTipoComponente(Constants.TIPO_COMPONENTE_RC);
			comp.setProgrComponente(ConvertUtil.convertToString(progressivo));

			theModel.setAppDatacomponenteRC(comp);
			theModel.setAppDatalistaComponentiRC(null);
	...
	private void compilaComponente(String codImpianto, int progressivo,
		...
		try {
			List<SigitVCompRcDto> compList = getDbMgr().getSigitVCompRcDao().findByCodImpiantoOrdered(filter);

			ComponenteRC componenteRC = MapDto.mapToComponentePrincRC(compList);
			theModel.setAppDatacomponenteRC(componenteRC);
			...
			boolean isRipristinabile = GenericUtil.isUtenteAutorLibWebScheda9(theModel.getAppDatautenteLoggato())
					&& !componenteRC.getFlgDismesso();

			theModel.setAppDatalistaComponentiRC(MapDto.mapToComponenteSostRC(compList, isRipristinabile));
	...
	private void sostituisciComponente(ComponenteRC componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_6.CpGestLibScheda9_6DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			if (compList == null) {
				compList = new ArrayList<ComponenteRC>();
				theModel.setAppDatalistaComponentiRC(compList);
			}

			compList.add(0, componente);

			ComponenteRC componenteNew = new ComponenteRC();
			...
			theModel.setAppDatacomponenteRC(componenteNew);
	...
	private void riattivaComponente(ComponenteRC componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_6.CpGestLibScheda9_6DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			ComponenteRC componenteNew = compList.get(0);
