package it.csi.sigit.sigitwebn.business.gestisci_libretto_scheda8;
...
/*PROTECTED REGION ID(R1039115227) ENABLED START*/
import it.csi.sigit.sigitwebn.business.dao.sigitwebn.dto.SigitVCompAcDto;
...
public class CPBECpGestLibScheda8Dett {
	...
	// ApplicationData: [componenteAC, scope:USER_SESSION]
	public static final String APPDATA_COMPONENTEAC_CODE = "appDatacomponenteAC";
	...
	// ApplicationData: [listaComponentiAC, scope:USER_SESSION]
	public static final String APPDATA_LISTACOMPONENTIAC_CODE = "appDatalistaComponentiAC";
	...
	public static final String CPNAME = "cpGestLibScheda8Dett";
	 ...
	 * ContentPanel cpGestLibScheda8Dett
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda8.CpGestLibScheda8DettModel theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R1054957837) ENABLED START*/
	...
	public ExecResults sostituisciComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-351123956) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			try {
				ComponenteAC componente = theModel.getAppDatacomponenteAC();
				ArrayList<ComponenteAC> compList = theModel.getAppDatalistaComponentiAC();

				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda8Dett(componente, compList, true);
	...
	public ExecResults dismettiComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1347734642) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				theModel.setAppDatacomponenteAC(componente);
	...
	public ExecResults rollbackComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1288862899) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults attivaColonna(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1524016313) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults ripristinaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1852280250) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazioneRipristina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1204005725) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1008909280) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda8Dett(componente, compList, false);
				...
				getDbMgr().salvaComponenteAC(codImpiantoSelez, componente, compList, utente.getCodiceFiscale());
	...
	public ExecResults gestisciIndietro(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1079781989) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1719926792) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponenteDett(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R2062170049) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			//devo recuperare le combo fabbricante e coibentazione
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R316534796) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			UtenteLoggato utente = theModel.getAppDatautenteLoggato();

			if (GenericUtil.isUtenteAutorLibWebScheda8(utente)) {
				// impostazione del result code 
	...
	public ExecResults gestisciVisualizzazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1112611224) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R991283494) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda8Dett_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R1058924793) ENABLED START*/
	...
	private void recuperaComponenteDett(
		...
		if (isNuovoComponente) {
			...
			ComponenteAC compAC = new ComponenteAC();

			progressivo++;

			compAC.setIdComponente(Constants.TIPO_COMPONENTE_AC + Constants.INTERVAL_SEP + progressivo);
			compAC.setIdTipoComponente(Constants.TIPO_COMPONENTE_AC);
			compAC.setProgrComponente(ConvertUtil.convertToString(progressivo));

			theModel.setAppDatacomponenteAC(compAC);
			theModel.setAppDatalistaComponentiAC(null);
	...
	private void compilaComponente(String codImpianto, int progressivo,
		...
		try {
			List<SigitVCompAcDto> compList = getDbMgr().getSigitVCompAcDao().findByCodImpiantoOrdered(filter);

			ComponenteAC componenteAC = MapDto.mapToComponentePrincAC(compList);
			theModel.setAppDatacomponenteAC(componenteAC);

			// Il primo elemento delle sostituzioni e' ripristinabile se l'utente e' abilitato e se l'elemento attuale non e' dismesso 
			boolean isRipristinabile = GenericUtil.isUtenteAutorLibWebScheda8(theModel.getAppDatautenteLoggato())
					&& !componenteAC.getFlgDismesso();

			theModel.setAppDatalistaComponentiAC(MapDto.mapToComponenteSostAC(compList, isRipristinabile));
	...
	private void sostituisciComponente(ComponenteAC componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda8.CpGestLibScheda8DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			if (compList == null) {
				compList = new ArrayList<ComponenteAC>();
				theModel.setAppDatalistaComponentiAC(compList);
			}

			compList.add(0, componente);

			ComponenteAC componenteNew = new ComponenteAC();
			...
			theModel.setAppDatacomponenteAC(componenteNew);
	...
	private void riattivaComponente(ComponenteAC componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda8.CpGestLibScheda8DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			ComponenteAC componenteNew = compList.get(0);
