package it.csi.sigit.sigitwebn.business.gestisci_libretto_scheda11_4;
...
/*PROTECTED REGION ID(R-1670401293) ENABLED START*/
...
public class CPBECpGestLibScheda11_4 {
	...
	public static final String CPNAME = "cpGestLibScheda11_4";
	 ...
	 * ContentPanel cpGestLibScheda11_4
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda11_4.CpGestLibScheda11_4Model theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R-649367003) ENABLED START*/
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R480828896) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults caricaScheda(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R855009003) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			List<SigitVCompCgDettDto> listControlli = getDbMgr().getCompCgProgrDett(codiceImpianto,
					GenericUtil.getProgrComponente(scheda11Int.getComponente()), scheda11Int.getIdAllegato());

			ArrayList<Scheda11> scheda11 = MapDto.mapToScheda11_4(listControlli);
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-713041346) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbModuli(java.util.Map session) {
		session.put("cpGestLibScheda11_4_tbModuli_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R-276035109) ENABLED START*/
