...
public class LimammEnteServiceLocator extends org.apache.axis.client.Service implements it.csi.sigit.sigitwebn.business.ws.service.svista.client.LimammEnteService {
    ...
    public it.csi.sigit.sigitwebn.business.ws.service.svista.client.LimammEnte_PortType getlimammEnte() throws javax.xml.rpc.ServiceException {
    ...
    public it.csi.sigit.sigitwebn.business.ws.service.svista.client.LimammEnte_PortType getlimammEnte(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.csi.sigit.sigitwebn.business.ws.service.svista.client.LimammEnteSoapBindingStub _stub = new it.csi.sigit.sigitwebn.business.ws.service.svista.client.LimammEnteSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.csi.sigit.sigitwebn.business.ws.service.svista.client.LimammEnte_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                it.csi.sigit.sigitwebn.business.ws.service.svista.client.LimammEnteSoapBindingStub _stub = new it.csi.sigit.sigitwebn.business.ws.service.svista.client.LimammEnteSoapBindingStub(new java.net.URL(limammEnte_address), this);
                _stub.setPortName(getlimammEnteWSDDServiceName());
                return _stub;
            }
        }
