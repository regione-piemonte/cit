package it.csi.sigit.sigitwebn.business.gestisci_libretto_scheda4_8;
...
/*PROTECTED REGION ID(R-1657699962) ENABLED START*/
import it.csi.sigit.sigitwebn.business.dao.sigitwebn.dto.SigitVCompAgDto;
...
public class CPBECpGestLibScheda4_8Dett {
	...
	// ApplicationData: [componenteAG, scope:USER_SESSION]
	public static final String APPDATA_COMPONENTEAG_CODE = "appDatacomponenteAG";

	// ApplicationData: [listaComponentiAG, scope:USER_SESSION]
	public static final String APPDATA_LISTACOMPONENTIAG_CODE = "appDatalistaComponentiAG";
	...
	public static final String CPNAME = "cpGestLibScheda4_8Dett";
	 ...
	 * ContentPanel cpGestLibScheda4_8Dett
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_8.CpGestLibScheda4_8DettModel theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R603350264) ENABLED START*/
	...
	public ExecResults sostituisciComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1960664183) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			try {
				ComponenteAG componente = theModel.getAppDatacomponenteAG();
				ArrayList<ComponenteAG> compList = theModel.getAppDatalistaComponentiAG();

				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda4_8Dett(componente, compList, true);
	...
	public ExecResults dismettiComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1832299779) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				theModel.setAppDatacomponenteAG(componente);
	...
	public ExecResults rollbackComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1891171522) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults attivaColonna(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1320835556) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults ripristinaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R439050875) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazioneRipristina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1351869176) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-403849589) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda4_8Dett(componente, compList, false);
				...
				getDbMgr().salvaComponenteAG(codImpiantoSelez, componente, compList, utente.getCodiceFiscale(),
	...
	public ExecResults gestisciIndietro(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1866173584) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1226028781) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponenteDett(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1662918828) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R824648833) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R647913939) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R539675921) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda4_8Dett_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R748265134) ENABLED START*/
	...
	private void recuperaComponenteDett(
		...
		if (isNuovoComponente) {
			...
			ComponenteAG compAG = new ComponenteAG();

			progressivo++;

			compAG.setIdComponente(Constants.TIPO_COMPONENTE_AG + Constants.INTERVAL_SEP + progressivo);
			compAG.setIdTipoComponente(Constants.TIPO_COMPONENTE_AG);
			compAG.setProgrComponente(ConvertUtil.convertToString(progressivo));

			theModel.setAppDatacomponenteAG(compAG);
			theModel.setAppDatalistaComponentiAG(null);
	...
	private void compilaComponente(String codImpianto, int progressivo,
		...
		try {
			List<SigitVCompAgDto> compList = getDbMgr().getSigitVCompAgDao().findByCodImpiantoOrdered(filter);

			ComponenteAG componenteAG = MapDto.mapToComponentePrincAG(compList);
			theModel.setAppDatacomponenteAG(componenteAG);
			...
			boolean isRipristinabile = GenericUtil.isUtenteAutorLibWebScheda4(theModel.getAppDatautenteLoggato())
					&& !componenteAG.getFlgDismesso();

			theModel.setAppDatalistaComponentiAG(MapDto.mapToComponenteSostAG(compList, isRipristinabile));
	...
	private void sostituisciComponente(ComponenteAG componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_8.CpGestLibScheda4_8DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			if (compList == null) {
				compList = new ArrayList<ComponenteAG>();
				theModel.setAppDatalistaComponentiAG(compList);
			}

			compList.add(0, componente);

			ComponenteAG componenteNew = new ComponenteAG();
			...
			theModel.setAppDatacomponenteAG(componenteNew);
	...
	private void riattivaComponente(ComponenteAG componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_8.CpGestLibScheda4_8DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			ComponenteAG componenteNew = compList.get(0);
