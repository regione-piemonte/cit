...
/*PROTECTED REGION ID(R-1736147663) ENABLED START*/
...
public class CPBECpGestRapProvaTipo1 {
	...
	// ApplicationData: [TipoGT, scope:USER_SESSION]
	public static final String APPDATA_TIPOGT_CODE = "appDataTipoGT";
	...
	public static final String CPNAME = "cpGestRapProvaTipo1";
	 ...
	 * ContentPanel cpGestRapProvaTipo1
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_rapprova.CpGestRapProvaTipo1Model theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R1355744995) ENABLED START*/
	...
	public ExecResults salvaRapProva(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R266153038) ENABLED START*/
			TipoGT allegatoGT = theModel.getAppDataTipoGT();

			DettaglioAllegato dettaglioAllegato = theModel.getAppDataallegatoIsp();
			try {
				getValidationMgr().validazioneFormaleRappProvaGT(dettaglioAllegato, allegatoGT,
						dettaglioAllegato.getCodiceImpianto());

				getDbMgr().salvaRappProvaTipoGT(allegatoGT, dettaglioAllegato,
	...
	public ExecResults tornaPaginaChiamante(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R170841484) ENABLED START*/
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1334145054) ENABLED START*/
	...
	/**
	 * Implementazione del metodo caricaRapProvaTipo1 definito in un ExecCommand del
	 * ContentPanel cpGestRapProvaTipo1
	 */
	public ExecResults caricaRapProvaTipo1(

			it.csi.sigit.sigitwebn.dto.gestisci_rapprova.CpGestRapProvaTipo1Model theModel

	) throws BEException {
		/// definizione costanti di outcome
		final String CARICARAPPROVATIPO1_OUTCOME_CODE__OK = //NOSONAR  Reason:EIAS
				"OK"; //NOSONAR  Reason:EIAS
		///
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1265030277) ENABLED START*/
			//in base all'id dell'allegato viene caricato il rapporto di prova
			...
			TipoGT allegatoGT = getSigitMgr().getAllegatoRappProvaTipoGT(allegato.getIdAllegato(),
					allegato.getCodiceImpianto());
			theModel.setAppDataTipoGT(allegatoGT);

			// impostazione del result code 
			result.setResultCode(CARICARAPPROVATIPO1_OUTCOME_CODE__OK);

			result.setModel(theModel);
			return result;
			/*PROTECTED REGION END*/
		} catch (Exception e) {
			log.error("[BackEndFacade::caricaRapProvaTipo1] Errore occorso nell'esecuzione del metodo:" + e, e);
			throw new BEException("Errore occorso nell'esecuzione del metodo:" + e, e);
		}
	}
	...
	public ExecResults caricaMenu(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R281748728) ENABLED START*/
			DettaglioAllegato allegato = theModel.getAppDataallegatoIsp();
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1292070652) ENABLED START*/
	...
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R-421056803) ENABLED START*/
