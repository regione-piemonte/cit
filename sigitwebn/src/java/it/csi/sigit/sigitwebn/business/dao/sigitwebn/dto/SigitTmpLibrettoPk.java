...
/**
 * Primary Key del DTO SigitTmpLibrettoDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTmpLibrettoPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTmpLibrettoPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTmpLibrettoPk)) {
			return false;
		}

		final SigitTmpLibrettoPk _cast = (SigitTmpLibrettoPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitwebn.business.dao.sigitwebn.dto.SigitTmpLibrettoPk: ");
