package it.csi.sigit.sigitwebn.business.gestisci_libretto_scheda11_1;
...
/*PROTECTED REGION ID(R-138798762) ENABLED START*/
...
public class CPBECpGestLibScheda11_1 {
	...
	public static final String CPNAME = "cpGestLibScheda11_1";
	 ...
	 * ContentPanel cpGestLibScheda11_1
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda11_1.CpGestLibScheda11_1Model theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R-742426424) ENABLED START*/
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-571570915) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults caricaScheda(
		...
		/// definizione costanti di outcome
		final String CARICASCHEDA_OUTCOME_CODE__PAGINATA = //NOSONAR  Reason:EIAS
				"PAGINATA"; //NOSONAR  Reason:EIAS
		final String CARICASCHEDA_OUTCOME_CODE__NON_PAGINATA = //NOSONAR  Reason:EIAS
				"NON_PAGINATA"; //NOSONAR  Reason:EIAS
		///
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-2029833048) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			// ArrayList<Scheda11> scheda11 = getSigitMgr().ricercaScheda11_1(codiceImpianto, progressivo);
			List<SigitVCompGtDettDto> listControlli = getDbMgr().getCompGtProgrDett(codiceImpianto,
					GenericUtil.getProgrComponente(scheda11Int.getComponente()), scheda11Int.getIdAllegato());

			ArrayList<Scheda11> scheda11 = null;

			if (listControlli != null && listControlli.size() > Constants.MAX_NUMERO_NON_PAGINATO) {
				scheda11 = MapDto.mapToScheda11_1Pag(listControlli);

				// impostazione del result code 
				result.setResultCode(CARICASCHEDA_OUTCOME_CODE__PAGINATA);
			} else {

				scheda11 = MapDto.mapToScheda11_1(listControlli);

				// impostazione del result code 
				result.setResultCode(CARICASCHEDA_OUTCOME_CODE__NON_PAGINATA);
			}
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-806100767) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbModuli(java.util.Map session) {
		session.put("cpGestLibScheda11_1_tbModuli_clearStatus", Boolean.TRUE);
	}

	/**
	 * permette di resettare lo stato di paginazione della tabella widg_tbModuliPag
	 */
	public static void resetClearStatus_widg_tbModuliPag(java.util.Map session) {
		session.put("cpGestLibScheda11_1_tbModuliPag_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R-2037586792) ENABLED START*/
