...
public class SigitTStoricoVariazStatoDaoImpl extends AbstractDAO implements SigitTStoricoVariazStatoDao {
	...
	protected SigitTStoricoVariazStatoDaoRowMapper findByCodiceImpiantoRowMapper = new SigitTStoricoVariazStatoDaoRowMapper(
			null, SigitTStoricoVariazStatoDto.class, this);
	...
	public List<SigitTStoricoVariazStatoDto> findFindByCodiceImpianto(java.lang.Integer input)
		...
		try {
			...
			stopWatch.dumpElapsed("SigitTStoricoVariazStatoDaoImpl", "findFindByCodiceImpianto", "esecuzione query",
					sql.toString());
