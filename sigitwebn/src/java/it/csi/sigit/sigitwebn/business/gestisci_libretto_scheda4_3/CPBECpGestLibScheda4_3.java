...
/*PROTECTED REGION ID(R1100511660) ENABLED START*/
...
public class CPBECpGestLibScheda4_3 {
	...
	public static final String CPNAME = "cpGestLibScheda4_3";
	 ...
	 * ContentPanel cpGestLibScheda4_3
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_3.CpGestLibScheda4_3Model theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R-1476794978) ENABLED START*/
	...
	public ExecResults aggiungiRiga(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R183016667) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			List<CodeDescription> gtList = getSigitMgr().getListaComponentiGT(theModel.getAppDataidImpiantoSelez());

			try {
				getValidationMgr().checkPopolamentoListaGT(gtList, Constants.TIPO_COMPONENTE_RC);
	...
	public ExecResults dettaglioRiga(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1250842643) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			try {
	...
	public ExecResults eliminaRiga(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1305206649) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults tornaPaginaChiamante(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1141070129) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaEliminaComponente(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1181924735) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				getDbMgr().cancellaComponenteBRRC(codImpianto, ConvertUtil.convertToString(progressivo),
						utente.getCodiceFiscale(), Constants.TIPO_COMPONENTE_RC);
	...
	public ExecResults annullaEliminaComponente(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1685945955) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1451535879) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults caricaScheda(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R974545554) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			List<ComponenteBRRC> compList = getSigitMgr().cercaComponentiBrRcByFilter(codiceImpianto, null,
					Constants.TIPO_COMPONENTE_RC, true, true);
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1598882149) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			UtenteLoggato utente = theModel.getAppDatautenteLoggato();
	...
	public ExecResults aggiornaDatiPagina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-571560519) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1540469321) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda4_3_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R465186376) ENABLED START*/
