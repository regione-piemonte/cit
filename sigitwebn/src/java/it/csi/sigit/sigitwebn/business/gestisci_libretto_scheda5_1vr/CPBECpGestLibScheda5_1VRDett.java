package it.csi.sigit.sigitwebn.business.gestisci_libretto_scheda5_1vr;
...
/*PROTECTED REGION ID(R-1326308464) ENABLED START*/
import it.csi.sigit.sigitwebn.business.dao.sigitwebn.dto.SigitVCompVrDto;
...
public class CPBECpGestLibScheda5_1VRDett {
	...
	// ApplicationData: [componenteVR, scope:USER_SESSION]
	public static final String APPDATA_COMPONENTEVR_CODE = "appDatacomponenteVR";

	// ApplicationData: [listaComponentiVR, scope:USER_SESSION]
	public static final String APPDATA_LISTACOMPONENTIVR_CODE = "appDatalistaComponentiVR";
	...
	public static final String CPNAME = "cpGestLibScheda5_1VRDett";
	 ...
	 * ContentPanel cpGestLibScheda5_1VRDett
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_1vr.CpGestLibScheda5_1VRDettModel theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R298025602) ENABLED START*/
	...
	public ExecResults sostituisciComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1416406273) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			try {
				ComponenteVR componente = theModel.getAppDatacomponenteVR();
				ArrayList<ComponenteVR> compList = theModel.getAppDatalistaComponentiVR();

				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda5_1VRDett(componente, compList, true);
	...
	public ExecResults dismettiComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R957169849) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				theModel.setAppDatacomponenteVR(componente);
	...
	public ExecResults rollbackComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1016041592) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults attivaColonna(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-38388498) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults ripristinaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1252778161) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazioneRipristina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R848434962) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1419294357) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda5_1VRDett(componente, compList, false);
				...
				getDbMgr().salvaComponenteVR(codImpiantoSelez, componente, compList, utente.getCodiceFiscale());

				theModel.setAppDataisNuovoComponente(false);
				theModel.setAppDatarigaSelezionata(ReplaceSpecialCharUtils.sanitize(componente.getIdComponente()));
	...
	public ExecResults gestisciIndietro(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-2120919738) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1533902755) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponenteDett(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-513665994) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R2069996087) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R860455005) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R234351259) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda5_1VRDett_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R62549924) ENABLED START*/
	...
	private void recuperaComponenteDett(
		...
		if (isNuovoComponente) {
			...
			ComponenteVR compVR = new ComponenteVR();

			progressivo++;

			compVR.setIdComponente(Constants.TIPO_COMPONENTE_VR + Constants.INTERVAL_SEP + progressivo);
			compVR.setIdTipoComponente(Constants.TIPO_COMPONENTE_VR);
			compVR.setProgrComponente(ConvertUtil.convertToString(progressivo));

			theModel.setAppDatacomponenteVR(compVR);
			theModel.setAppDatalistaComponentiVR(null);
		} else {
	...
	private void compilaComponente(String codImpianto, int progressivo,
		...
		try {
			List<SigitVCompVrDto> compList = getDbMgr().getSigitVCompVrDao().findByCodImpiantoOrdered(filter);

			ComponenteVR componenteVR = MapDto.mapToComponentePrincVR(compList);
			theModel.setAppDatacomponenteVR(componenteVR);
			...
			boolean isRipristinabile = GenericUtil.isUtenteAutorLibWebScheda5_1(theModel.getAppDatautenteLoggato())
					&& !componenteVR.getFlgDismesso();

			theModel.setAppDatalistaComponentiVR(MapDto.mapToComponenteSostVR(compList, isRipristinabile));
	...
	private void sostituisciComponente(ComponenteVR componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_1vr.CpGestLibScheda5_1VRDettModel theModel)
			throws ManagerException {
		...
		try {
			...
			if (compList == null) {
				compList = new ArrayList<ComponenteVR>();
				theModel.setAppDatalistaComponentiVR(compList);
			}

			compList.add(0, componente);

			ComponenteVR componenteNew = new ComponenteVR();
			...
			theModel.setAppDatacomponenteVR(componenteNew);
	...
	private void riattivaComponente(ComponenteVR componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_1vr.CpGestLibScheda5_1VRDettModel theModel)
			throws ManagerException {
		...
		try {
			...
			ComponenteVR componenteNew = compList.get(0);
