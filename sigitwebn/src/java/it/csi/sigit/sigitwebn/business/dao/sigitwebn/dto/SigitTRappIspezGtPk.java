...
/**
 * Primary Key del DTO SigitTRappIspezGtDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTRappIspezGtPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTRappIspezGtPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTRappIspezGtPk)) {
			return false;
		}

		final SigitTRappIspezGtPk _cast = (SigitTRappIspezGtPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitwebn.business.dao.sigitwebn.dto.SigitTRappIspezGtPk: ");
