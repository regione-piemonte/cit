...
/*PROTECTED REGION ID(R-518453743) ENABLED START*/
...
public class CPBECpGestLibScheda5_1VR {
	...
	public static final String CPNAME = "cpGestLibScheda5_1VR";
	 ...
	 * ContentPanel cpGestLibScheda5_1VR
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_1vr.CpGestLibScheda5_1VRModel theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R-1217005629) ENABLED START*/
	...
	public ExecResults nuovoComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-885376546) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults dettaglioComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-327916076) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults eliminaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-671951954) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults tornaPaginaChiamante(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1486413996) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaEliminaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-2119081197) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				// Recupero tutta la storia del componenet per capire se e' eliminabile, se ci sono dei sostituti non si puo' cancellare
				Integer progressivo = GenericUtil.getProgrComponente(idComponenteSelezionato);

				boolean isUltimoCom = false;
				// Devo capire se sto cancellando l'ultimo componente VR, se e' l'ultimo devo impostare a 0 
				// il campo l5_1_flg_valvole_regolazione della tabella sigit_t_compx_semplice
				ArrayList<Componente> compList = theModel.getAppDatalistaComponenti();
				if (compList != null && compList.size() == 1) {
					// Sto' cancellando l'ultimo componente
					isUltimoCom = true;
				}

				getDbMgr().cancellaComponenteVR(codImpianto, ConvertUtil.convertToString(progressivo), isUltimoCom,
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1964561662) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponente(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R602627256) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			String codiceImpianto = theModel.getAppDataidImpiantoSelez();

			ArrayList<Componente> compList = getSigitMgr().ricercaComponenteVR(codiceImpianto);
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1253538282) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults aggiornaDatiPagina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-2086283276) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1280679972) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda5_1VR_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R-1946561789) ENABLED START*/
