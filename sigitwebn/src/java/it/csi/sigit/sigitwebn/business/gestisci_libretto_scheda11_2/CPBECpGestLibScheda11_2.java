package it.csi.sigit.sigitwebn.business.gestisci_libretto_scheda11_2;
...
/*PROTECTED REGION ID(R-649332939) ENABLED START*/
...
public class CPBECpGestLibScheda11_2 {
	...
	public static final String CPNAME = "cpGestLibScheda11_2";
	 ...
	 * ContentPanel cpGestLibScheda11_2
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda11_2.CpGestLibScheda11_2Model theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R-711406617) ENABLED START*/
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-220770978) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults caricaScheda(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1068219031) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			List<SigitVCompGfDettDto> listControlli = getDbMgr().getCompGfProgrDett(codiceImpianto,
			...
			if (listControlli != null && listControlli.size() > Constants.MAX_NUMERO_NON_PAGINATO) {
				scheda11 = MapDto.mapToScheda11_2Pag(listControlli);

				// impostazione del result code 
				result.setResultCode(CARICASCHEDA_OUTCOME_CODE__PAGINATA);
			} else {

				scheda11 = MapDto.mapToScheda11_2(listControlli);
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-775080960) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbModuli(java.util.Map session) {
		session.put("cpGestLibScheda11_2_tbModuli_clearStatus", Boolean.TRUE);
	}
	...
	public static void resetClearStatus_widg_tbModuliPag(java.util.Map session) {
		session.put("cpGestLibScheda11_2_tbModuliPag_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R1412908633) ENABLED START*/
