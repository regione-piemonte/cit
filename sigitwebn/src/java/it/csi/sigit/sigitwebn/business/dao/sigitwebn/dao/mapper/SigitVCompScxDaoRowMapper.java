...
/**
 * RowMapper specifico del DAO SigitVCompScxDao
 * @generated
 */
public class SigitVCompScxDaoRowMapper extends BaseDaoRowMapper implements org.springframework.jdbc.core.RowMapper {

	/**
	 * Dao associato al RowMapper. Serve per i supplier DAO
	 * @generated
	 */
	SigitVCompScxDaoImpl dao;
	 ...
	 */
	public SigitVCompScxDaoRowMapper(String[] columnsToRead, Class dtoClass, SigitVCompScxDao dao) {
		super(columnsToRead, dtoClass);
		this.dao = (SigitVCompScxDaoImpl) dao;
	}
	 ...
	 * @param row
	 * @throws SQLException
	 * @return SigitVCompScxDto
	 * @generated
	 */
	public Object mapRow(ResultSet rs, int row) throws SQLException {
		Object dtoInstance = getNewDto();

		if (dtoInstance instanceof SigitVCompScxDto) {
			return mapRow_internal((SigitVCompScxDto) dtoInstance, rs, row);
		}

		return dtoInstance;
	}

	public SigitVCompScxDto mapRow_internal(SigitVCompScxDto objectToFill, ResultSet rs, int row) throws SQLException {
		SigitVCompScxDto dto = objectToFill;
