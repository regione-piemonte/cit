...
/**
 * Primary Key del DTO SigitTRappIspezGfDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTRappIspezGfPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTRappIspezGfPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTRappIspezGfPk)) {
			return false;
		}

		final SigitTRappIspezGfPk _cast = (SigitTRappIspezGfPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitwebn.business.dao.sigitwebn.dto.SigitTRappIspezGfPk: ");
