...
/*PROTECTED REGION ID(R-1121485340) ENABLED START*/
...
public class CPBECpGestLibScheda9_6 {
	...
	public static final String CPNAME = "cpGestLibScheda9_6";
	 ...
	 * ContentPanel cpGestLibScheda9_6
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_6.CpGestLibScheda9_6Model theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R1637549014) ENABLED START*/
	...
	public ExecResults nuovoComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1119277391) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults dettaglioComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1585006297) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults eliminaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-2112364607) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults tornaPaginaChiamante(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-623592967) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaEliminaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R20966112) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				getDbMgr().cancellaComponenteRC(codImpianto, ConvertUtil.convertToString(progressivo),
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R175485647) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponente(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-575264949) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			String codiceImpianto = theModel.getAppDataidImpiantoSelez();

			ArrayList<Componente> compList = getSigitMgr().ricercaComponenteRC(codiceImpianto);
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R931422051) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults aggiornaDatiPagina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1504813185) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1573874671) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda9_6_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R-1011474672) ENABLED START*/
