package it.csi.sigit.sigitwebn.business.gestisci_libretto_scheda9_4;
...
/*PROTECTED REGION ID(R-1622749915) ENABLED START*/
import it.csi.sigit.sigitwebn.business.dao.sigitwebn.dto.SigitVCompCiDto;
...
public class CPBECpGestLibScheda9_4Dett {
	...
	// ApplicationData: [componenteCI, scope:USER_SESSION]
	public static final String APPDATA_COMPONENTECI_CODE = "appDatacomponenteCI";

	// ApplicationData: [listaComponentiCI, scope:USER_SESSION]
	public static final String APPDATA_LISTACOMPONENTICI_CODE = "appDatalistaComponentiCI";
	...
	public static final String CPNAME = "cpGestLibScheda9_4Dett";
	 ...
	 * ContentPanel cpGestLibScheda9_4Dett
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_4.CpGestLibScheda9_4DettModel theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R-902498857) ENABLED START*/
	...
	public ExecResults sostituisciComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-979737130) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			try {
				ComponenteCI componente = theModel.getAppDatacomponenteCI();
				ArrayList<ComponenteCI> compList = theModel.getAppDatalistaComponentiCI();

				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda9_4Dett(componente, compList, true);
	...
	public ExecResults dismettiComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1899350012) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				theModel.setAppDatacomponenteCI(componente);
	...
	public ExecResults rollbackComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1840478269) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults attivaColonna(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1603809027) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults ripristinaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R621293884) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazioneRipristina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R2056465575) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R671677226) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda9_4Dett(componente, compList, false);
				...
				getDbMgr().salvaComponenteCI(codImpiantoSelez, componente, compList, utente.getCodiceFiscale());
	...
	public ExecResults gestisciIndietro(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R908046097) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R267901294) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponenteDett(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1855364469) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-867950974) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-676881358) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-966173200) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda9_4Dett_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R-1731937617) ENABLED START*/
	...
	private void recuperaComponenteDett(
		...
		if (isNuovoComponente) {
			...
			ComponenteCI comp = new ComponenteCI();

			progressivo++;

			comp.setIdComponente(Constants.TIPO_COMPONENTE_CI + Constants.INTERVAL_SEP + progressivo);
			comp.setIdTipoComponente(Constants.TIPO_COMPONENTE_CI);
			comp.setProgrComponente(ConvertUtil.convertToString(progressivo));

			theModel.setAppDatacomponenteCI(comp);
			theModel.setAppDatalistaComponentiCI(null);
	...
	private void compilaComponente(String codImpianto, int progressivo,
		...
		try {
			List<SigitVCompCiDto> compList = getDbMgr().getSigitVCompCiDao().findByCodImpiantoOrdered(filter);

			ComponenteCI componenteCI = MapDto.mapToComponentePrincCI(compList);
			theModel.setAppDatacomponenteCI(componenteCI);
			...
			boolean isRipristinabile = GenericUtil.isUtenteAutorLibWebScheda9(theModel.getAppDatautenteLoggato())
					&& !componenteCI.getFlgDismesso();

			theModel.setAppDatalistaComponentiCI(MapDto.mapToComponenteSostCI(compList, isRipristinabile));
	...
	private void sostituisciComponente(ComponenteCI componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_4.CpGestLibScheda9_4DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			if (compList == null) {
				compList = new ArrayList<ComponenteCI>();
				theModel.setAppDatalistaComponentiCI(compList);
			}

			compList.add(0, componente);

			ComponenteCI componenteNew = new ComponenteCI();
			...
			theModel.setAppDatacomponenteCI(componenteNew);
	...
	private void riattivaComponente(ComponenteCI componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_4.CpGestLibScheda9_4DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			ComponenteCI componenteNew = compList.get(0);
