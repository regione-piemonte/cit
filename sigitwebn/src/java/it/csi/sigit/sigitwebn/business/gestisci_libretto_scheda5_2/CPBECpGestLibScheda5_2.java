package it.csi.sigit.sigitwebn.business.gestisci_libretto_scheda5_2;
...
/*PROTECTED REGION ID(R613973484) ENABLED START*/
...
public class CPBECpGestLibScheda5_2 {
	...
	// ApplicationData: [elencoTipologiaSistema, scope:USER_SESSION]
	public static final String APPDATA_ELENCOTIPOLOGIASISTEMA_CODE = "appDataelencoTipologiaSistema";

	// ApplicationData: [elencoTipoRegolazione, scope:USER_SESSION]
	public static final String APPDATA_ELENCOTIPOREGOLAZIONE_CODE = "appDataelencoTipoRegolazione";
	...
	// ApplicationData: [SistemiRegolazioneContabilizzazione, scope:USER_SESSION]
	public static final String APPDATA_SISTEMIREGOLAZIONECONTABILIZZAZIONE_CODE = "appDataSistemiRegolazioneContabilizzazione";
	...
	public static final String CPNAME = "cpGestLibScheda5_2";
	 ...
	 * ContentPanel cpGestLibScheda5_2
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_2.CpGestLibScheda5_2Model theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R-1762551330) ENABLED START*/
	...
	public ExecResults salvaScheda(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1719795882) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			SistemiRegolazioneContabilizzazione sistema = theModel.getAppDataSistemiRegolazioneContabilizzazione();
			UtenteLoggato utente = theModel.getAppDatautenteLoggato();
			String codiceImpianto = theModel.getAppDataidImpiantoSelez();

			try {
				getValidationMgr().validazioneFormaleLibrettoScheda5_2(sistema);
				getSigitMgr().salvaDatiScheda5_2Libretto(codiceImpianto, utente.getCodiceFiscale(), sistema);
	...
	public ExecResults ripristinaAttuale(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1152944722) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults tornaPaginaChiamante(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-254645007) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1082940985) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	/**
	 * Implementazione del metodo caricaScheda5_2 definito in un ExecCommand del
	 * ContentPanel cpGestLibScheda5_2
	 */
	public ExecResults caricaScheda5_2(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_2.CpGestLibScheda5_2Model theModel

	) throws BEException {
		/// definizione costanti di outcome
		final String CARICASCHEDA5_2_OUTCOME_CODE__OK = //NOSONAR  Reason:EIAS
				"OK"; //NOSONAR  Reason:EIAS
		///
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-208357410) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			if (theModel.getAppDataelencoTipoRegolazione() == null
					|| theModel.getAppDataelencoTipoRegolazione().isEmpty()) {
				theModel.setAppDataelencoTipoRegolazione(
						GenericUtil.getComboValues(TipoRegolazioneEnum.class.getName()));
			}

			if (theModel.getAppDataelencoTipologiaSistema() == null
					|| theModel.getAppDataelencoTipologiaSistema().isEmpty()) {
				theModel.setAppDataelencoTipologiaSistema(
						GenericUtil.getComboValues(DirettoIndirettoEnum.class.getName()));
			}

			if (theModel.getAppDataelencoPresenteAssente() == null
					|| theModel.getAppDataelencoPresenteAssente().isEmpty()) {
				theModel.setAppDataelencoPresenteAssente(
						GenericUtil.getComboValues(PresenteAssenteEnum.class.getName()));
			}

			if (theModel.getAppDataelencoSiNo() == null || theModel.getAppDataelencoSiNo().isEmpty()) {
			...
			// impostazione del result code 
			result.setResultCode(CARICASCHEDA5_2_OUTCOME_CODE__OK);
			...
			log.error("[BackEndFacade::caricaScheda5_2] Errore occorso nell'esecuzione del metodo:" + e, e);
			throw new BEException("Errore occorso nell'esecuzione del metodo:" + e, e);
		}
	}
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1300370011) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			UtenteLoggato utente = theModel.getAppDatautenteLoggato();

			// impostazione del result code 
			if (GenericUtil.isUtenteAutorLibWebScheda5(utente)) {
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1826225673) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R1521009160) ENABLED START*/
	...
	private void caricaScheda(it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda5_2.CpGestLibScheda5_2Model theModel)
			throws ManagerException {
		String codiceImpianto = theModel.getAppDataidImpiantoSelez();
		SistemiRegolazioneContabilizzazione sistemaRegolazioneContabilizzazione = getSigitMgr()
				.caricaDatiScheda5_2Libretto(codiceImpianto);

		theModel.setAppDataSistemiRegolazioneContabilizzazione(sistemaRegolazioneContabilizzazione);
	}
	/*PROTECTED REGION END*/
}
