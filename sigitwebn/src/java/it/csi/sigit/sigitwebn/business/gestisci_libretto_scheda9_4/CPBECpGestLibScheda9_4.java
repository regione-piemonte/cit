...
/*PROTECTED REGION ID(R-100416986) ENABLED START*/
...
public class CPBECpGestLibScheda9_4 {
	...
	public static final String CPNAME = "cpGestLibScheda9_4";
	 ...
	 * ContentPanel cpGestLibScheda9_4
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_4.CpGestLibScheda9_4Model theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R1575509400) ENABLED START*/
	...
	public ExecResults nuovoComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-985263885) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults dettaglioComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1075533207) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults eliminaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R2120563075) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults tornaPaginaChiamante(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R220412535) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaEliminaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-680633762) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				getDbMgr().cancellaComponenteCI(codImpianto, ConvertUtil.convertToString(progressivo),
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-526114227) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponente(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-597897203) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			String codiceImpianto = theModel.getAppDataidImpiantoSelez();

			ArrayList<Componente> compList = getSigitMgr().ricercaComponenteCI(codiceImpianto);
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1775427553) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults aggiornaDatiPagina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1577199743) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1511835057) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda9_4_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R677469070) ENABLED START*/
