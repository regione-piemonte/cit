...
/*PROTECTED REGION ID(R1225894761) ENABLED START*/
...
public class SigitVCompTeDaoImpl extends AbstractDAO implements SigitVCompTeDao {
	...
	public List<SigitVCompTeDto> findByCodImpiantoOrdered(
			it.csi.sigit.sigitwebn.business.dao.sigitwebn.filter.CompFilter input) throws SigitVCompTeDaoException {
		...
		sql.append(" WHERE ");
		/*PROTECTED REGION ID(R362414677) ENABLED START*/
		...
		/*PROTECTED REGION END*/
		/*PROTECTED REGION ID(R-769483123) ENABLED START*/
