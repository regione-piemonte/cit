...
/*PROTECTED REGION ID(R1431185545) ENABLED START*/
...
public class CPBECpGestLibScheda9_1 {
	...
	public static final String CPNAME = "cpGestLibScheda9_1";
	 ...
	 * ContentPanel cpGestLibScheda9_1
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_1.CpGestLibScheda9_1Model theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R1482449979) ENABLED START*/
	...
	public ExecResults nuovoComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-784243626) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults dettaglioComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-311323572) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			try {
	...
	public ExecResults eliminaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R2027503654) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults tornaPaginaChiamante(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-661062860) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaEliminaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1733033573) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				getDbMgr().cancellaComponenteTE(codImpianto, ConvertUtil.convertToString(progressivo),
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1578514038) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponente(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-631845584) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			String codiceImpianto = theModel.getAppDataidImpiantoSelez();

			ArrayList<Componente> compList = getSigitMgr().ricercaComponenteTE(codiceImpianto);
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R893952158) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults aggiornaDatiPagina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-461704068) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1418775636) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda9_1_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R-1084082613) ENABLED START*/
