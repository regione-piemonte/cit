...
/*PROTECTED REGION ID(R12086645) ENABLED START*/
...
public class SigitVCompVmDaoImpl extends AbstractDAO implements SigitVCompVmDao {
	...
	public List<SigitVCompVmDto> findByCodImpiantoOrdered(
			it.csi.sigit.sigitwebn.business.dao.sigitwebn.filter.CompFilter input) throws SigitVCompVmDaoException {
		...
		sql.append(" WHERE ");
		/*PROTECTED REGION ID(R-1989819237) ENABLED START*/
		...
		/*PROTECTED REGION END*/
		/*PROTECTED REGION ID(R-674290425) ENABLED START*/
