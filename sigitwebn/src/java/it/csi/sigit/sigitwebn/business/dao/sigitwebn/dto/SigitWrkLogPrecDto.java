...
/**
 * Data transfer object relativo al DAO SigitWrkLogPrecDao.
 * @generated
 */
public class SigitWrkLogPrecDto extends SigitWrkLogPrecPk {
	...
	/**
	 * Crea una istanza di SigitWrkLogPrecPk a partire dal valore dei campi chiave del DTO
	 * 
	 * @return SigitWrkLogPrecPk
	 * @generated
	 */
	public SigitWrkLogPrecPk createPk() {
		return new SigitWrkLogPrecPk(idLog);
	}
