...
/**
 * Primary Key del DTO SigitTStoricoVarStatoDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTStoricoVarStatoPk implements Serializable {
	 ...
	 * @generated 
	 */
	public SigitTStoricoVarStatoPk() {
		//empty constructor
	}
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTStoricoVarStatoPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTStoricoVarStatoPk)) {
			return false;
		}

		final SigitTStoricoVarStatoPk _cast = (SigitTStoricoVarStatoPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitwebn.business.dao.sigitwebn.dto.SigitTStoricoVarStatoPk: ");
