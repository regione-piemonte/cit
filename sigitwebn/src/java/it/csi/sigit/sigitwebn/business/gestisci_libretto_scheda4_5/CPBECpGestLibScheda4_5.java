...
/*PROTECTED REGION ID(R79443306) ENABLED START*/
...
public class CPBECpGestLibScheda4_5 {
	...
	public static final String CPNAME = "cpGestLibScheda4_5";
	 ...
	 * ContentPanel cpGestLibScheda4_5
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_5.CpGestLibScheda4_5Model theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R-1414755364) ENABLED START*/
	...
	public ExecResults aggiungiRiga(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R2106244701) ENABLED START*/
	...
	public ExecResults dettaglioRiga(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1760315733) ENABLED START*/
			try {
	...
	public ExecResults eliminaRiga(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1243167035) ENABLED START*/
			try {
				...
				if (count != null && count.intValue() > 1) {
					...
					ComponenteSC componenteToDelete = (ComponenteSC) getSigitMgr()
							.cercaComponente4AttivaByFilter(codImpianto, progressivo, Constants.TIPO_COMPONENTE_SC);

					if (componenteToDelete != null) {
						//controllo su ree: se esiste un ree legato alla componente attiva non e' possibile l'eliminazione
						getSigitMgr().checkPresenzaREEComponenteDaEliminare(codImpianto, Constants.TIPO_COMPONENTE_SC,
	...
	public ExecResults tornaPaginaChiamante(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R297064627) ENABLED START*/
	...
	public ExecResults salvaEliminaComponente(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1841456257) ENABLED START*/
			...
			getDbMgr().cancellaComponenteSC(filtroDaCancellare, utente.getCodiceFiscale());
	...
	public ExecResults annullaEliminaComponente(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-159421211) ENABLED START*/
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-2141831543) ENABLED START*/
	...
	public ExecResults caricaScheda(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1397193708) ENABLED START*/
			String codiceImpianto = theModel.getAppDataidImpiantoSelez();

			//carico la lista delle componenti distinte
			List<ComponenteSC> compList = getSigitMgr().cercaComponentiScByFilter(codiceImpianto, null, true);

			theModel.setAppDatalistaComponentiSC((ArrayList<ComponenteSC>) compList);
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1852079645) ENABLED START*/
			UtenteLoggato utente = theModel.getAppDatautenteLoggato();
	...
	public ExecResults aggiornaDatiPagina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-643947077) ENABLED START*/
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1478429707) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda4_5_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R-1223757366) ENABLED START*/
