package it.csi.sigit.sigitwebn.business.gestisci_libretto_scheda9_2;
...
/*PROTECTED REGION ID(R-805101465) ENABLED START*/
import it.csi.sigit.sigitwebn.business.dao.sigitwebn.dto.SigitVCompRvDto;
...
public class CPBECpGestLibScheda9_2Dett {
	...
	// ApplicationData: [componenteRV, scope:USER_SESSION]
	public static final String APPDATA_COMPONENTERV_CODE = "appDatacomponenteRV";

	// ApplicationData: [listaComponentiRV, scope:USER_SESSION]
	public static final String APPDATA_LISTACOMPONENTIRV_CODE = "appDatalistaComponentiRV";
	...
	public static final String CPNAME = "cpGestLibScheda9_2Dett";
	 ...
	 * ContentPanel cpGestLibScheda9_2Dett
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_2.CpGestLibScheda9_2DettModel theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R-925131111) ENABLED START*/
	...
	public ExecResults sostituisciComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1264246168) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			try {
				ComponenteRV componente = theModel.getAppDatacomponenteRV();
				ArrayList<ComponenteRV> compList = theModel.getAppDatalistaComponentiRV();

				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda9_2Dett(componente, compList, true);
	...
	public ExecResults dismettiComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1694017410) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				theModel.setAppDatacomponenteRV(componente);
	...
	public ExecResults rollbackComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1752889153) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults attivaColonna(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1329049413) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults ripristinaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R693680442) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazioneRipristina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R518125545) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1181150316) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda9_2Dett(componente, compList, false);
				...
				getDbMgr().salvaComponenteRV(codImpiantoSelez, componente, compList, utente.getCodiceFiscale());
	...
	public ExecResults gestisciIndietro(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1752051599) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1111906796) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponenteDett(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-826005171) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R977416192) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-925027852) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-988805454) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda9_2Dett_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R73500717) ENABLED START*/
	...
	private void recuperaComponenteDett(
		...
		if (isNuovoComponente) {
			...
			ComponenteRV comp = new ComponenteRV();

			progressivo++;

			comp.setIdComponente(Constants.TIPO_COMPONENTE_RV + Constants.INTERVAL_SEP + progressivo);
			comp.setIdTipoComponente(Constants.TIPO_COMPONENTE_RV);
			comp.setProgrComponente(ConvertUtil.convertToString(progressivo));

			theModel.setAppDatacomponenteRV(comp);
			theModel.setAppDatalistaComponentiRV(null);
	...
	private void compilaComponente(String codImpianto, int progressivo,
		...
		try {
			List<SigitVCompRvDto> compList = getDbMgr().getSigitVCompRvDao().findByCodImpiantoOrdered(filter);

			ComponenteRV componenteRV = MapDto.mapToComponentePrincRV(compList);
			theModel.setAppDatacomponenteRV(componenteRV);
			...
			boolean isRipristinabile = GenericUtil.isUtenteAutorLibWebScheda9(theModel.getAppDatautenteLoggato())
					&& !componenteRV.getFlgDismesso();

			theModel.setAppDatalistaComponentiRV(MapDto.mapToComponenteSostRV(compList, isRipristinabile));
	...
	private void sostituisciComponente(ComponenteRV componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_2.CpGestLibScheda9_2DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			if (compList == null) {
				compList = new ArrayList<ComponenteRV>();
				theModel.setAppDatalistaComponentiRV(compList);
			}
 
			compList.add(0, componente);

			ComponenteRV componenteNew = new ComponenteRV();
			...
			theModel.setAppDatacomponenteRV(componenteNew);
	...
	private void riattivaComponente(ComponenteRV componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_2.CpGestLibScheda9_2DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			ComponenteRV componenteNew = compList.get(0);
