package it.csi.sigit.sigitwebn.business.gestisci_libretto_scheda9_5;
...
/*PROTECTED REGION ID(R-2031574140) ENABLED START*/
import it.csi.sigit.sigitwebn.business.dao.sigitwebn.dto.SigitVCompUtDto;
...
public class CPBECpGestLibScheda9_5Dett {
	...
	// ApplicationData: [componenteUT, scope:USER_SESSION]
	public static final String APPDATA_COMPONENTEUT_CODE = "appDatacomponenteUT";

	// ApplicationData: [listaComponentiUT, scope:USER_SESSION]
	public static final String APPDATA_LISTACOMPONENTIUT_CODE = "appDatalistaComponentiUT";
	...
	public static final String CPNAME = "cpGestLibScheda9_5Dett";
	 ...
	 * ContentPanel cpGestLibScheda9_5Dett
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_5.CpGestLibScheda9_5DettModel theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R-891182730) ENABLED START*/
	...
	public ExecResults sostituisciComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R45754869) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			try {
				ComponenteUT componente = theModel.getAppDatacomponenteUT();
				ArrayList<ComponenteUT> compList = theModel.getAppDatalistaComponentiUT();

				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda9_5Dett(componente, compList, true);
	...
	public ExecResults dismettiComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1548550075) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				theModel.setAppDatacomponenteUT(componente);
	...
	public ExecResults rollbackComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1489678332) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults attivaColonna(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-406294814) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults ripristinaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1562383043) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazioneRipristina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1469331706) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R416940681) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				// VALIDAZIONE
				getValidationMgr().validazioneFormaleLibrettoScheda9_5Dett(componente, compList, false);
				...
				getDbMgr().salvaComponenteUT(codImpiantoSelez, componente, compList, utente.getCodiceFiscale());
	...
	public ExecResults gestisciIndietro(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1661440302) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1993382191) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponenteDett(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-222560470) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1790634557) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciVisualizzazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-552808111) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-954857073) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda9_5Dett_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R-487173136) ENABLED START*/
	...
	private void recuperaComponenteDett(
		...
		if (isNuovoComponente) {
			...
			ComponenteUT comp = new ComponenteUT();

			progressivo++;

			comp.setIdComponente(Constants.TIPO_COMPONENTE_UT + Constants.INTERVAL_SEP + progressivo);
			comp.setIdTipoComponente(Constants.TIPO_COMPONENTE_UT);
			comp.setProgrComponente(ConvertUtil.convertToString(progressivo));

			theModel.setAppDatacomponenteUT(comp);
			theModel.setAppDatalistaComponentiUT(null);
	...
	private void compilaComponente(String codImpianto, int progressivo,
		...
		try {
			List<SigitVCompUtDto> compList = getDbMgr().getSigitVCompUtDao().findByCodImpiantoOrdered(filter);

			ComponenteUT componenteUT = MapDto.mapToComponentePrincUT(compList);
			theModel.setAppDatacomponenteUT(componenteUT);
			...
			boolean isRipristinabile = GenericUtil.isUtenteAutorLibWebScheda9(theModel.getAppDatautenteLoggato())
					&& !componenteUT.getFlgDismesso();

			theModel.setAppDatalistaComponentiUT(MapDto.mapToComponenteSostUT(compList, isRipristinabile));
	...
	private void sostituisciComponente(ComponenteUT componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_5.CpGestLibScheda9_5DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			if (compList == null) {
				compList = new ArrayList<ComponenteUT>();
				theModel.setAppDatalistaComponentiUT(compList);
			}

			compList.add(0, componente);

			ComponenteUT componenteNew = new ComponenteUT();
			...
			theModel.setAppDatacomponenteUT(componenteNew);
	...
	private void riattivaComponente(ComponenteUT componente,
			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_5.CpGestLibScheda9_5DettModel theModel)
			throws ManagerException {
		...
		try {
			...
			ComponenteUT componenteNew = compList.get(0);
