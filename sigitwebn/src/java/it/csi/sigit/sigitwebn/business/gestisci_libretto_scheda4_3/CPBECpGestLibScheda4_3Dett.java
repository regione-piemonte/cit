package it.csi.sigit.sigitwebn.business.gestisci_libretto_scheda4_3;
...
/*PROTECTED REGION ID(R386421163) ENABLED START*/
...
public class CPBECpGestLibScheda4_3Dett {
	...
	public static final String CPNAME = "cpGestLibScheda4_3Dett";
	 ...
	 * ContentPanel cpGestLibScheda4_3Dett
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda4_3.CpGestLibScheda4_3DettModel theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R546769629) ENABLED START*/
	...
	public ExecResults sostituisciComponente(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R413858883) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			ComponenteBRRC componente = theModel.getAppDatacomponenteBRRC();
			componente.setFabbricanteLabel(GenericUtil.getDescriptionByCod(
					ReplaceSpecialCharUtils.sanitize(componente.getFabbricante()),
			...
			try {
				...
				getValidationMgr().validazioneFormaleLibrettoScheda4_2_4_3Dett(componente,
						(ArrayList<ComponenteBRRC>) compList, true, Constants.TIPO_COMPONENTE_RC, result);
	...
	public ExecResults dismettiComponente(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-604027227) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults riattivaComponente(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1931669058) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults riattivaComponenteSostituita(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R708438293) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults ripristinaDettaglioAttuale(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1272218262) ENABLED START*/
	...
	public ExecResults gestisciAbilitazioneByFlgDismissioneOnRipristina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-198897195) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaDettaglio(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-266605970) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				getValidationMgr().validazioneFormaleLibrettoScheda4_2_4_3Dett(componente, compList, false,
						Constants.TIPO_COMPONENTE_RC, result);
	...
	public ExecResults gestisciIndietroDaDettaglio(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R331081919) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1188558888) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults caricaSchedaDett(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-324826254) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1143099452) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			UtenteLoggato utente = theModel.getAppDatautenteLoggato();
	...
	public ExecResults gestisciAbilitazioneByFlgDismissioneOnEnter(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-2029055104) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R483095286) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbSostituzioni(java.util.Map session) {
		session.put("cpGestLibScheda4_3Dett_tbSostituzioni_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R-1180589975) ENABLED START*/
	...
	private void recuperaComponenteDett(
		...
		if (isNuovoComponente) {
			...
			ComponenteBRRC componenteNew = new ComponenteBRRC();
			componenteNew.setComponente(Constants.TIPO_COMPONENTE_RC + Constants.INTERVAL_SEP + progressivo);
			componenteNew.setFlgDismesso(false);
			...
			try {
				...
				List<ComponenteBRRC> compList = getSigitMgr().cercaComponentiBrRcByFilter(codImpiantoSelez, progressivo,
						Constants.TIPO_COMPONENTE_RC, false, false);
