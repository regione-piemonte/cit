 ...
 * @generated
 */
public class SigitTStoricoVarStatoMetadata extends DAOMetadata {
	 ...
	 * DAO: [SigitTStoricoVarStato]
	 * tabella: [SIGIT_T_STORICO_VARIAZ_STATO].
	 */
	public SigitTStoricoVarStatoMetadata() {
	...
	/**
	 * Method 'getTableName'
	 * Restituisce il nome della tabella a cui il DAO [SigitTStoricoVarStato] fa riferimento
