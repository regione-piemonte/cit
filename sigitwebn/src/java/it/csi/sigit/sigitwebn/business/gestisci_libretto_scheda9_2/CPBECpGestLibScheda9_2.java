...
/*PROTECTED REGION ID(R920651368) ENABLED START*/
...
public class CPBECpGestLibScheda9_2 {
	...
	public static final String CPNAME = "cpGestLibScheda9_2";
	 ...
	 * ContentPanel cpGestLibScheda9_2
	 */
	public ExecResults onTreeClick(

			it.csi.sigit.sigitwebn.dto.gestisci_libretto_scheda9_2.CpGestLibScheda9_2Model theModel
		...
		try {
			...
			/*PROTECTED REGION ID(R1513469786) ENABLED START*/
	...
	public ExecResults nuovoComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-851250379) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults dettaglioComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-566060117) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults eliminaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R2058523461) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults tornaPaginaChiamante(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1064418037) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults salvaEliminaComp(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1382233636) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				...
				getDbMgr().cancellaComponenteRV(codImpianto, ConvertUtil.convertToString(progressivo),
	...
	public ExecResults isRuoloAbilitato(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1227714101) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults cercaComponente(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-620529457) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:

			String codiceImpianto = theModel.getAppDataidImpiantoSelez();

			ArrayList<Componente> compList = getSigitMgr().ricercaComponenteRV(codiceImpianto);
	...
	public ExecResults gestisciAbilitazione(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R-1675534241) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults aggiornaDatiPagina(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1649586301) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public ExecResults gestisciMsg(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R1449795443) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
	...
	public static void resetClearStatus_widg_tbComponenti(java.util.Map session) {
		session.put("cpGestLibScheda9_2_tbComponenti_clearStatus", Boolean.TRUE);
	}

	//////////////////////////////////////////////////////////////////////////////
	/// Property aggiuntive del bean
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R-1928554484) ENABLED START*/
