...
/**
 * Arricchimenti standard per il ContentPanel [cpGestLibScheda6_4Dett] da registrare nella
 * variabile globale uiEnricherMgr
 */
function initStdEnrichments4CpGestLibScheda6_4Dett() {
	var contentPanelName = "cpGestLibScheda6_4Dett";
	...
	/// arricchimento per guigen::ComboBox [cbGiriVar]: autonarrowing
	var addNarrowingToCbGiriVar =
		function(){
			uiNRichLib.addComboNarrowingNRich(
				'widg_cbGiriVar',
			 	false);
		};
	uiEnricherMgr.registerEnrichment(contentPanelName, "p_wpComp", addNarrowingToCbGiriVar);


	/// arricchimento di base per guigen::TextField [tPotNom]
	var addBasicEnrichmentToTPotNom =
		function(){
			uiNRichLib.basicTextFieldNRich(
				'widg_tPotNom',
			 	false,
	...
	uiEnricherMgr.registerEnrichment(contentPanelName, "p_wpComp", addBasicEnrichmentToTPotNom);
 ...
 */
function initCustomEnrichments4CpGestLibScheda6_4Dett(){
/*PROTECTED REGION ID(R566052939) ENABLED START*/
	/*
...
function initUIStructCpGestLibScheda6_4Dett(){
	var contentPanelName = "cpGestLibScheda6_4Dett";
	var structure =
      {
        name: "p_fpGestLibScheda6_4Dett", panels: [
        {
...
$( function() {
	...
	initStdEnrichments4CpGestLibScheda6_4Dett();
	initCustomEnrichments4CpGestLibScheda6_4Dett();
	initUIStructCpGestLibScheda6_4Dett();
	uiEnricherMgr.setReady();
	uiEnricherMgr.applyAll("cpGestLibScheda6_4Dett");
