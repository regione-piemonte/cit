...
/**
 * Arricchimenti standard per il ContentPanel [cpGestLibScheda9_2Dett] da registrare nella
 * variabile globale uiEnricherMgr
 */
function initStdEnrichments4CpGestLibScheda9_2Dett() {
	var contentPanelName = "cpGestLibScheda9_2Dett";
 ...
 */
function initCustomEnrichments4CpGestLibScheda9_2Dett(){
/*PROTECTED REGION ID(R434830540) ENABLED START*/
	/*
...
function initUIStructCpGestLibScheda9_2Dett(){
	var contentPanelName = "cpGestLibScheda9_2Dett";
	var structure =
      {
        name: "p_fpGestLibScheda9_2Dett", panels: [
        {
...
$( function() {
	...
	initStdEnrichments4CpGestLibScheda9_2Dett();
	initCustomEnrichments4CpGestLibScheda9_2Dett();
	initUIStructCpGestLibScheda9_2Dett();
	uiEnricherMgr.setReady();
	uiEnricherMgr.applyAll("cpGestLibScheda9_2Dett");
