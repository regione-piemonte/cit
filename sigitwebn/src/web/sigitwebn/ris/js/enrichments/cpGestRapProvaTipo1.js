...
/**
 * Arricchimenti standard per il ContentPanel [cpGestRapProvaTipo1] da registrare nella
 * variabile globale uiEnricherMgr
 */
function initStdEnrichments4CpGestRapProvaTipo1() {
	var contentPanelName = "cpGestRapProvaTipo1";
	...
	/// arricchimento di base per guigen::TextField [tfpotenzautile]
	var addBasicEnrichmentToTfpotenzautile =
		function(){
			uiNRichLib.basicTextFieldNRich(
				'widg_tfpotenzautile',
			 	true,
	...
	uiEnricherMgr.registerEnrichment(contentPanelName, "p_wpDatiGenerali", addBasicEnrichmentToTfpotenzautile);
	...
	uiEnricherMgr.registerEnrichment(contentPanelName, "p_wpStatoDoc", addBasicEnrichmentToTfNumero);
 ...
 */
function initCustomEnrichments4CpGestRapProvaTipo1(){
/*PROTECTED REGION ID(R-59726980) ENABLED START*/
	/*
...
function initUIStructCpGestRapProvaTipo1(){
	var contentPanelName = "cpGestRapProvaTipo1";
	var structure =
      {
        name: "p_fpGestRapProvaTipo1", panels: [
        {
...
$( function() {
	...
	initStdEnrichments4CpGestRapProvaTipo1();
	initCustomEnrichments4CpGestRapProvaTipo1();
	initUIStructCpGestRapProvaTipo1();
	uiEnricherMgr.setReady();
	uiEnricherMgr.applyAll("cpGestRapProvaTipo1");
