...
<%@taglib uri="/csiuicore" prefix="csiuicore" %>
	...
	<div id="p_fpDatiIspezioneIn" class="formPanelBlock"><!-- startFragment:p_fpDatiIspezioneIn -->
		
	
<div class="formPanel floatWrapper" id="fpDatiIspezioneIn">
...
<s:submit name="widg_btnCreaIspezione" id="widg_btnCreaIspezione" method="handleBtnCreaIspezione_CLICKED"
	...
	<!-- endFragment:p_fpDatiIspezioneIn --></div>
