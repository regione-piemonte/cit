...
<s:form id="dpEliminaComponentePOForm" action="cpGestLibScheda6_4" namespace="/base/gestisci_libretto_scheda6_4" method="post">
	...
	<div id="contentPanel">
		<div id="centerWrapper" class="floatWrapper">
			...
			<a id="main_content" name="main_content"></a>
				<div class="dialogPanel" id="dpEliminaComponentePO">
...
<s:if test="isWidgetVisible('cpGestLibScheda6_4','ptMessaggioDinamico')" >
...
<s:if test="isWidgetVisible('cpGestLibScheda6_4','btAnnullaElim')" >
...
<s:submit name="widg_btAnnullaElim" id="widg_btAnnullaElim" method="handleBtAnnullaElim_CLICKED"
	key="cpGestLibScheda6_4.btAnnullaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda6_4','btAnnullaElim')" />
...
<s:if test="isWidgetVisible('cpGestLibScheda6_4','btConfermaElim')" >
...
<s:submit name="widg_btConfermaElim" id="widg_btConfermaElim" method="handleBtConfermaElim_CLICKED"
	key="cpGestLibScheda6_4.btConfermaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda6_4','btConfermaElim')" />
