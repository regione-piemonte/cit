...
<s:form id="dpEliminaComponenteForm" action="cpGestLibScheda10_1" namespace="/base/gestisci_libretto_scheda10_1" method="post">
	...
	<div id="contentPanel">
		<div id="centerWrapper" class="floatWrapper">
			...
			<a id="main_content" name="main_content"></a>
				<div class="dialogPanel" id="dpEliminaComponente">
...
<s:if test="isWidgetVisible('cpGestLibScheda10_1','ptMessaggioDinamico')" >
...
<s:if test="isWidgetVisible('cpGestLibScheda10_1','btAnnullaElim')" >
...
<s:submit name="widg_btAnnullaElim" id="widg_btAnnullaElim" method="handleBtAnnullaElim_CLICKED"
	key="cpGestLibScheda10_1.btAnnullaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda10_1','btAnnullaElim')" />
...
<s:if test="isWidgetVisible('cpGestLibScheda10_1','btConfermaElim')" >
...
<s:submit name="widg_btConfermaElim" id="widg_btConfermaElim" method="handleBtConfermaElim_CLICKED"
	key="cpGestLibScheda10_1.btConfermaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda10_1','btConfermaElim')" />
