...
<s:form id="dpEliminaComponenteSCForm" action="cpGestLibScheda4_5" namespace="/base/gestisci_libretto_scheda4_5" method="post">
	...
	<div id="contentPanel">
		<div id="centerWrapper" class="floatWrapper">
			...
			<a id="main_content" name="main_content"></a>
				<div class="dialogPanel" id="dpEliminaComponenteSC">
...
<s:if test="isWidgetVisible('cpGestLibScheda4_5','ptMessaggioDinamico')" >
...
<s:if test="isWidgetVisible('cpGestLibScheda4_5','btAnnullaElim')" >
...
<s:submit name="widg_btAnnullaElim" id="widg_btAnnullaElim" method="handleBtAnnullaElim_CLICKED"
	key="cpGestLibScheda4_5.btAnnullaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda4_5','btAnnullaElim')" />
...
<s:if test="isWidgetVisible('cpGestLibScheda4_5','btConfermaElim')" >
...
<s:submit name="widg_btConfermaElim" id="widg_btConfermaElim" method="handleBtConfermaElim_CLICKED"
	key="cpGestLibScheda4_5.btConfermaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda4_5','btConfermaElim')" />
