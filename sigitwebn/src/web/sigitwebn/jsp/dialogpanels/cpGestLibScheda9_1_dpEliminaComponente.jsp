...
<s:form id="dpEliminaComponenteForm" action="cpGestLibScheda9_1" namespace="/base/gestisci_libretto_scheda9_1" method="post">
...
<s:if test="isWidgetVisible('cpGestLibScheda9_1','ptMessaggioDinamico')" >
...
<s:if test="isWidgetVisible('cpGestLibScheda9_1','btAnnullaElim')" >
...
<s:submit name="widg_btAnnullaElim" id="widg_btAnnullaElim" method="handleBtAnnullaElim_CLICKED"
	key="cpGestLibScheda9_1.btAnnullaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda9_1','btAnnullaElim')" />
...
<s:if test="isWidgetVisible('cpGestLibScheda9_1','btConfermaElim')" >
...
<s:submit name="widg_btConfermaElim" id="widg_btConfermaElim" method="handleBtConfermaElim_CLICKED"
	key="cpGestLibScheda9_1.btConfermaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda9_1','btConfermaElim')" />
