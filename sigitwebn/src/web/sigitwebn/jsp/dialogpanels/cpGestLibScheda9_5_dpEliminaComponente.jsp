...
<s:form id="dpEliminaComponenteForm" action="cpGestLibScheda9_5" namespace="/base/gestisci_libretto_scheda9_5" method="post">
...
<s:if test="isWidgetVisible('cpGestLibScheda9_5','ptMessaggioDinamico')" >
...
<s:if test="isWidgetVisible('cpGestLibScheda9_5','btAnnullaElim')" >
...
<s:submit name="widg_btAnnullaElim" id="widg_btAnnullaElim" method="handleBtAnnullaElim_CLICKED"
	key="cpGestLibScheda9_5.btAnnullaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda9_5','btAnnullaElim')" />
...
<s:if test="isWidgetVisible('cpGestLibScheda9_5','btConfermaElim')" >
...
<s:submit name="widg_btConfermaElim" id="widg_btConfermaElim" method="handleBtConfermaElim_CLICKED"
	key="cpGestLibScheda9_5.btConfermaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda9_5','btConfermaElim')" />
