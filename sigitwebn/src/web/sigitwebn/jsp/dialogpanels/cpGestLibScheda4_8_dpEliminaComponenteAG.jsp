...
<s:form id="dpEliminaComponenteAGForm" action="cpGestLibScheda4_8" namespace="/base/gestisci_libretto_scheda4_8" method="post">
	...
	<div id="contentPanel">
		<div id="centerWrapper" class="floatWrapper">
			...
			<a id="main_content" name="main_content"></a>
				<div class="dialogPanel" id="dpEliminaComponenteAG">
...
<s:if test="isWidgetVisible('cpGestLibScheda4_8','ptMessaggioDinamico')" >
...
<s:if test="isWidgetVisible('cpGestLibScheda4_8','btAnnullaElim')" >
...
<s:submit name="widg_btAnnullaElim" id="widg_btAnnullaElim" method="handleBtAnnullaElim_CLICKED"
	key="cpGestLibScheda4_8.btAnnullaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda4_8','btAnnullaElim')" />
...
<s:if test="isWidgetVisible('cpGestLibScheda4_8','btConfermaElim')" >
...
<s:submit name="widg_btConfermaElim" id="widg_btConfermaElim" method="handleBtConfermaElim_CLICKED"
	key="cpGestLibScheda4_8.btConfermaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda4_8','btConfermaElim')" />
