...
<s:form id="dpEliminaComponenteBRRCForm" action="cpGestLibScheda4_2" namespace="/base/gestisci_libretto_scheda4_2" method="post">
...
<s:if test="isWidgetVisible('cpGestLibScheda4_2','ptMessaggioDinamico')" >
...
<s:if test="isWidgetVisible('cpGestLibScheda4_2','btAnnullaElim')" >
...
<s:submit name="widg_btAnnullaElim" id="widg_btAnnullaElim" method="handleBtAnnullaElim_CLICKED"
	key="cpGestLibScheda4_2.btAnnullaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda4_2','btAnnullaElim')" />
...
<s:if test="isWidgetVisible('cpGestLibScheda4_2','btConfermaElim')" >
...
<s:submit name="widg_btConfermaElim" id="widg_btConfermaElim" method="handleBtConfermaElim_CLICKED"
	key="cpGestLibScheda4_2.btConfermaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda4_2','btConfermaElim')" />
