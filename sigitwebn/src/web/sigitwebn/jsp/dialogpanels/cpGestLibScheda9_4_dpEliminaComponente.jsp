...
<s:form id="dpEliminaComponenteForm" action="cpGestLibScheda9_4" namespace="/base/gestisci_libretto_scheda9_4" method="post">
...
<s:if test="isWidgetVisible('cpGestLibScheda9_4','ptMessaggioDinamico')" >
...
<s:if test="isWidgetVisible('cpGestLibScheda9_4','btAnnullaElim')" >
...
<s:submit name="widg_btAnnullaElim" id="widg_btAnnullaElim" method="handleBtAnnullaElim_CLICKED"
	key="cpGestLibScheda9_4.btAnnullaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda9_4','btAnnullaElim')" />
...
<s:if test="isWidgetVisible('cpGestLibScheda9_4','btConfermaElim')" >
...
<s:submit name="widg_btConfermaElim" id="widg_btConfermaElim" method="handleBtConfermaElim_CLICKED"
	key="cpGestLibScheda9_4.btConfermaElim.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpGestLibScheda9_4','btConfermaElim')" />
